...
final class ReflectionRepository
{
    ...
    public static final Class<?> classProperty;
    ...
    public static final Class<?> classIWorldReader;
    ...
    static
    {
        ...
        classEntityFallingBlock = findClass("net.minecraft.world.entity.item.FallingBlockEntity").get();
        ...
        classBlockBase = findClass("net.minecraft.world.level.block.state.BlockBehaviour").get();
        ...
        classProperty = findClass("net.minecraft.world.level.block.state.properties.Property").get();
        classIBlockData = findClass("net.minecraft.world.level.block.state.BlockState").get();
        classStateHolder = findClass("net.minecraft.world.level.block.state.StateHolder").get();
        ...
        classCrashReportSystemDetails = findClass("net.minecraft.CrashReportCategory").get();
        ...
        classBlockStateEnum = findClass("net.minecraft.world.level.block.state.properties.EnumProperty").get();
        ...
        classMinecraftKey = findClass("net.minecraft.resources.Identifier").get();


        cTorPrivateNMSFallingBlockEntity = findConstructor()
        ...
        cTorVec3D = findConstructor()
            ...
            .get();
        ctorCraftEntity = findConstructor()
            .inClass(classCraftEntity)
            .withParameters(classCraftServer, classNMSEntity)
            .get();
        ctorBlockBase = findConstructor()
            .inClass(classBlockBase)
            .withParameters(classBlockBaseInfo)
            .get();
        ctorLocation = findConstructor()
            .inClass(Location.class)
        ...
        methodGetIBlockData = findMethod()
            ...
            .withoutParameters()
            .get();
        methodNewBlockPosition = findMethod()
            .inClass(classBlockPosition)
            .withReturnType(classBlockPosition)
            .withParameters(double.class, double.class, double.class)
            .withModifiers(Modifier.STATIC, Modifier.PUBLIC)
            .get();
        methodGetBlockData = findMethod()
            .inClass(Block.class)
            .withName("getBlockData")
            .withoutParameters()
            .get();
        methodSetBlockData = findMethod()
            .inClass(Block.class)
            .withName("setBlockData")
            .withParameters(BlockData.class)
            .get();
        methodGetBlockMaterial = findMethod()
            .inClass(Block.class)
            .withName("getType")
            .withoutParameters().get();
        methodGetCraftBlockDataState = findMethod()
            .inClass(classCraftBlockData)
            .withName("getState")
            .withoutParameters()
            .get();
        methodLocationGetBlock = findMethod()
            .inClass(Location.class)
            .withName("getBlock")
            .withoutParameters()
            .get();
        methodLocationGetWorld = findMethod()
            .inClass(Location.class)
            .withName("getWorld")
            .withoutParameters()
            .get();
        methodLocationGetX = findMethod()
            .inClass(Location.class)
            .withName("getX")
            .withoutParameters()
            .get();
        methodLocationGetY = findMethod()
            .inClass(Location.class)
            .withName("getY")
            .withoutParameters()
            .get();
        methodLocationGetZ = findMethod()
            .inClass(Location.class)
            .withName("getZ")
            .withoutParameters()
            .get();
        methodGetWorldHandle = findMethod()
            .inClass(classCraftWorld)
            .withName("getHandle")
            .withoutParameters()
            .withModifiers(Modifier.PUBLIC)
            .get();
        methodGetEntityHandle = findMethod()
            .inClass(classCraftEntity).withName("getHandle")
            .withoutParameters()
            .withModifiers(Modifier.PUBLIC)
            .get();
        methodTick = findTickMethod();
        methodHurtEntities = findMethod()
            .inClass(classEntityFallingBlock)
        ...
        methodEntityFallingBlockGetBlock = findMethod()
            ...
            .withoutParameters()
            .get();
        methodSetStartPos = findMethod()
            .inClass(classEntityFallingBlock)
            .withReturnType(void.class)
            .withModifiers(Modifier.PUBLIC)
            .withParameters(classBlockPosition)
            .get();
        methodAppendEntityCrashReport = findMethod()
            .inClass(classEntityFallingBlock)
            .withReturnType(void.class)
            .withModifiers(Modifier.PUBLIC)
            .withParameters(classCrashReportSystemDetails)
            .get();
        methodCrashReportAppender = findMethod()
            .inClass(classCrashReportSystemDetails)
        ...
        methodBlockBaseGetItem = findMethod()
            ...
            .withoutParameters()
            .withModifiers(Modifier.ABSTRACT, Modifier.PUBLIC)
            .get();
        ...
        methodSetIBlockDataHolderState = ReflectionBuilder
            .findMethod()
            .inClass(classStateHolder)
            .findMultiple()
            .atLeast(1)
            .atMost(2)
            .withParameters(classProperty, Comparable.class)
            .withReturnType(classStateHolder.getTypeParameters()[1])
            .get()
            .getFirst();
        methodCraftMagicNumbersGetMaterial = findMethod()
            .inClass(classCraftMagicNumbers)
            .withName("getMaterial")
            .withParameters(classIBlockData)
            .get();
        methodCraftEntitySetTicksLived = findMethod()
            .inClass(classCraftEntity)
            .withName("setTicksLived")
            .withParameters(int.class)
            .get();
        methodMatchXMaterial = findMethod()
            .inClass(XMaterial.class)
            .withName("matchXMaterial")
            .withParameters(Material.class)
            .get();
        methodGetBlockAtCoords = findMethod()
            .inClass(World.class)
            .withName("getBlockAt")
            .withParameters(int.class, int.class, int.class)
            .get();
        methodGetBlockFromBlockData = findMethod()
            .inClass(classBlockData)
            .withReturnType(classBlock)
            .withoutParameters()
            .get();
        methodRotateBlockData = findMethod()
            .inClass(classBlockData)
            .withReturnType(classIBlockData)
            .withModifiers(Modifier.PUBLIC)
        ...
        methodGetTypeFromBlockPosition = findMethod()
            ...
            .withParameters(classBlockPosition)
            .get();
        methodGetBukkitServer = findMethod()
            .inClass(Bukkit.class)
            .withName("getServer")
            .get();
        methodIsAssignableFrom = findMethod()
            .inClass(Class.class)
            .withName("isAssignableFrom")
            .withParameters(Class.class)
            .get();
        methodSetBlockType = findMethod()
            .inClass(Block.class)
            .withName("setType")
            .withParameters(Material.class, boolean.class)
            .get();
        methodEnumOrdinal = findMethod()
            .inClass(Enum.class)
            .withName("ordinal")
            .get();
        methodArrayGetIdx = findMethod()
            .inClass(Array.class)
            .withName("get")
            .withParameters(Object.class, int.class)
            .get();
        methodGetClass = findMethod()
        ...
        methodGetIBlockDataHolderState = ReflectionASMAnalyzers
            .getGetIBlockDataHolderStateMethod(
                classCraftBlockData,
                classBlockStateEnum,
                classIBlockData,
                classProperty,
        ...
        methodIsAir = ReflectionASMAnalyzers
            .getIsAirMethod(methodTick, classIBlockData, classBlockData);
        methodDie = ReflectionASMAnalyzers
            .getCraftEntityDieMethod(
                classCraftEntity,
                classNMSEntity,
                classEntityRemoveEventCause
            );
        ...
        methodLoadData = findMethod()
            ...
            .get();
        final Method[] locationMethods = ReflectionASMAnalyzers
            .getEntityLocationMethods(
                classCraftEntity,
                classNMSEntity
            );
        ...
        methodRegistriesRegisterNew = findMethod()
            .inClass(classRegistries)
        ...
        fieldTicksLived = findField()
            .inClass(classEntityFallingBlock)
            .ofType(int.class)
            .withModifiers(Modifier.PUBLIC)
            .get();

        fieldBlockRotatableAxis = findField()
            .inClass(classBlockRotatable)
            .ofType(classBlockStateEnum)
        ...
        objectEntityRemoveEventCausePlugin =
            findEnumValues()
                .inClass(classEntityRemoveEventCause)
                .withName("PLUGIN")
                .get();
    ...
    private static Method findTickMethod()
    {
        ...
        final List<Method> filtered =
            fbMethods.stream()
                .filter(method -> baseMethods.contains(method.getName()))
                .collect(Collectors.toList());
    ...
    private static <T> T invoke(Method method, @Nullable Object source, Object... params)
    {
        ...
        catch (Exception exception)
        {
            throw new RuntimeException(
                "Could not invoke method '" + method +
                    "' on source: '" + source +
