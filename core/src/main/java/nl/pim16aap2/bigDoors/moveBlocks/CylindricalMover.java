...
import nl.pim16aap2.bigDoors.util.CylindricalMoverTask;
...
public class CylindricalMover extends BlockMover {
    ...
    private void createAnimatedBlocks() {
        ...
        final List<NMSBlock> edges = new ArrayList<>(Math.min(door.getBlockCount(),
            ...
            do {
                ...
                for (int yAxis = yMin; yAxis <= yMax; yAxis++) {
                    ...
                    BigDoors.getScheduler().runTask(vBlock.getLocation(),
                            new CylindricalMoverTask(savedBlocks, edges, yMax, zMin, zMax, xMin, xMax, yMin, radius,
                                    startLocation, newFBlockLocation, this.rotDirection, instantOpen, fabf, world,
    ...
    private void rotateEntities() {
        ...
        animationRunnable = new BukkitRunnable() {
            final Location center = new Location(world, turningPoint.getBlockX() + 0.5, yMin,
