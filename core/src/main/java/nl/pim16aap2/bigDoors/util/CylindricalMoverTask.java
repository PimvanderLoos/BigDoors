...
public class CylindricalMoverTask extends BukkitRunnable {
    ...
    public CylindricalMoverTask(ArrayList<MyBlockData> savedBlocks, List<NMSBlock> edges, int yMax, int zMin, int zMax, int xMin, int xMax, int yMin, double radius, Location startLocation, Location newFBlockLocation, RotateDirection rotDir, boolean instantOpen, FallingBlockFactory fabf, World world, Block vBlock, int xAxis, int yAxis, int zAxis) {
    ...
    public void run() {
        ...
        if (Util.isAllowedBlock(mat)) {
            ...
            if (canRotate != 0) {
                ...
                if (BigDoors.isOnFlattenedVersion()) {
                    if (canRotate == 6 || canRotate == 8 || canRotate == 9) {
                        ...
                        block2.rotateCylindrical(rotDir);
                    } else {
                        b.setType(mat);
            ...
            if (newFBlockLocation == null) {
                Bukkit.getLogger().info("BBB");
                return;
            }   
