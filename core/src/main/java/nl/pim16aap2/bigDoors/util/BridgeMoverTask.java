...
public class BridgeMoverTask extends BukkitRunnable {
    ...
    public BridgeMoverTask(DoorDirection openDirection, boolean NS, ArrayList<MyBlockData> savedBlocks, List<NMSBlock> edges, int yMax, int zMin, int zMax, int xMin, int xMax, int yMin, double radius, Location startLocation, Location newFBlockLocation, boolean instantOpen, FallingBlockFactory fabf, World world, Block vBlock, int xAxis, int yAxis, int zAxis) {
