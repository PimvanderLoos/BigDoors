...
public class SlidingMoverTask extends BukkitRunnable {
    ...
    public SlidingMoverTask(ArrayList<MyBlockData> savedBlocks, List<NMSBlock> edges, int yMax, int zMin, int zMax, int xMin, int xMax, int yMin, Location startLocation, Location newFBlockLocation, boolean instantOpen, FallingBlockFactory fabf, World world, Block vBlock, int xAxis, int yAxis, int zAxis) {
