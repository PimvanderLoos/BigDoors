...
VERSIONS=(     1.11.2 1.12.2 1.13   1.13.1 1.13.2 1.14.4 1.15.2 1.16.1 1.16.2 1.16.3 1.16.5 1.17.1  1.18.1  1.18.2  1.19    1.19.1  1.19.3  1.19.4  1.20.1  1.20.2  1.20.4  1.20.6  1.21.1)
JAVA_VERSIONS=("$J_8" "$J_8" "$J_8" "$J_8" "$J_8" "$J_8" "$J_8" "$J_8" "$J_8" "$J_8" "$J_8" "$J_17" "$J_17" "$J_17" "$J_17" "$J_17" "$J_17" "$J_17" "$J_17" "$J_17" "$J_17" "$J_17" "$J_21")
