...
public class TreeFeatures {
    ...
    public static void bootstrap(BootstapContext<WorldGenFeatureConfigured<?, ?>> bootstapcontext) {
        ...
        FeatureUtils.register(bootstapcontext, TreeFeatures.CHERRY, WorldGenerator.TREE, cherry().build());
        FeatureUtils.register(bootstapcontext, TreeFeatures.CHERRY_BEES_005, WorldGenerator.TREE, cherry().decorators(List.of(worldgenfeaturetreebeehive3)).build());
