...
public class Particles {
    ...
    public static final Particle<ParticleParamBlock> BLOCK_MARKER = register("block_marker", false, ParticleParamBlock.DESERIALIZER, ParticleParamBlock::codec);
    ...
    public static final ParticleType DRIPPING_CHERRY_LEAVES = register("dripping_cherry_leaves", false);
    public static final ParticleType FALLING_CHERRY_LEAVES = register("falling_cherry_leaves", false);
    public static final ParticleType LANDING_CHERRY_LEAVES = register("landing_cherry_leaves", false);
