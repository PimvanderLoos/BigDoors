...
public class CriterionConditionPlayer implements EntitySubPredicate {
    ...
    public static CriterionConditionPlayer fromJson(JsonObject jsonobject) {
        ...
        if (jsonarray != null) {
            ...
            while (iterator.hasNext()) {
                ...
                JsonObject jsonobject1 = ChatDeserializer.convertToJsonObject(jsonelement, "stats entry");
                MinecraftKey minecraftkey = new MinecraftKey(ChatDeserializer.getAsString(jsonobject1, "type"));
                StatisticWrapper<?> statisticwrapper = (StatisticWrapper) BuiltInRegistries.STAT_TYPE.get(minecraftkey);
    ...
    private static <T> Statistic<T> getStat(StatisticWrapper<T> statisticwrapper, MinecraftKey minecraftkey) {
        ...
        if (t0 == null) {
            throw new JsonParseException("Unknown object " + minecraftkey + " for stat type " + BuiltInRegistries.STAT_TYPE.getKey(statisticwrapper));
        } else {
    ...
    public JsonObject serializeCustomData() {
        ...
        if (!this.stats.isEmpty()) {
            ...
            this.stats.forEach((statistic, criterionconditionvalue_integerrange) -> {
                ...
                jsonobject1.addProperty("type", BuiltInRegistries.STAT_TYPE.getKey(statistic.getType()).toString());
