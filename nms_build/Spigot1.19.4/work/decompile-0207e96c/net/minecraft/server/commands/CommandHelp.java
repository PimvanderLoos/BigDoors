    ...
    public static void register(CommandDispatcher<CommandListenerWrapper> commanddispatcher) {
        commanddispatcher.register((LiteralArgumentBuilder) ((LiteralArgumentBuilder) net.minecraft.commands.CommandDispatcher.literal("help").executes((commandcontext) -> {
            ...
            while (iterator.hasNext()) {
                ...
                ((CommandListenerWrapper) commandcontext.getSource()).sendSuccess(IChatBaseComponent.literal("/" + s), false);
            }
            ...
            if (parseresults.getContext().getNodes().isEmpty()) {
                ...
                while (iterator.hasNext()) {
                    ...
                    commandlistenerwrapper.sendSuccess(IChatBaseComponent.literal("/" + s1 + " " + s), false);
                }
