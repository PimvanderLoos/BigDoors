...
public class CommandTime {
    ...
    private static int queryTime(CommandListenerWrapper commandlistenerwrapper, int i) {
        commandlistenerwrapper.sendSuccess(IChatBaseComponent.translatable("commands.time.query", i), false);
        return i;
    }
    ...
    public static int addTime(CommandListenerWrapper commandlistenerwrapper, int i) {
        ...
        commandlistenerwrapper.sendSuccess(IChatBaseComponent.translatable("commands.time.set", j), true);
        return j;
    }
}
