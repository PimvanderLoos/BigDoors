...
public abstract class TileEntityFurnace extends TileEntityContainer implements IWorldInventory, RecipeHolder, AutoRecipeOutput {
    ...
    public static Map<Item, Integer> getFuel() {
        ...
        add(map, TagsItem.BAMBOO_BLOCKS, 300);
        ...
        add(map, TagsItem.WOODEN_FENCES, 300);
        add(map, TagsItem.FENCE_GATES, 300);
        ...
        add(map, TagsItem.HANGING_SIGNS, 800);
    ...
    private static boolean canBurn(IRegistryCustom iregistrycustom, @Nullable IRecipe<?> irecipe, NonNullList<ItemStack> nonnulllist, int i) {
        if (!((ItemStack) nonnulllist.get(0)).isEmpty() && irecipe != null) {
            ItemStack itemstack = irecipe.getResultItem(iregistrycustom);
