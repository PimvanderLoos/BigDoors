...
public class LootItemFunctions {
    ...
    public static final LootItemFunctionType SET_INSTRUMENT = register("set_instrument", new SetInstrumentFunction.a());
    ...
    private static LootItemFunctionType register(String s, LootSerializer<? extends LootItemFunction> lootserializer) {
        return (LootItemFunctionType) IRegistry.register(BuiltInRegistries.LOOT_FUNCTION_TYPE, new MinecraftKey(s), new LootItemFunctionType(lootserializer));
    }
