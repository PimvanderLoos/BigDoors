...
public class TileEntityTypes<T extends TileEntity> {
    ...
    public static final TileEntityTypes<SuspiciousSandBlockEntity> SUSPICIOUS_SAND = register("suspicious_sand", TileEntityTypes.b.of(SuspiciousSandBlockEntity::new, Blocks.SUSPICIOUS_SAND));
