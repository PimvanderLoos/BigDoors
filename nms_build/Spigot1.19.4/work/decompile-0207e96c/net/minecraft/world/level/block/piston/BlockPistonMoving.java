...
public class BlockPistonMoving extends BlockTileEntity {
    ...
    public List<ItemStack> getDrops(IBlockData iblockdata, LootTableInfo.Builder loottableinfo_builder) {
        TileEntityPiston tileentitypiston = this.getBlockEntity(loottableinfo_builder.getLevel(), BlockPosition.containing((IPosition) loottableinfo_builder.getParameter(LootContextParameters.ORIGIN)));
