...
public final class OverworldBiomeBuilder {
    ...
    private final OverworldBiomeBuilder.a modifier;
    private final Climate.b FULL_RANGE;
    private final Climate.b[] temperatures;
    private final Climate.b[] humidities;
    private final Climate.b[] erosions;
    ...
    public OverworldBiomeBuilder() {
        this(OverworldBiomeBuilder.a.NONE);
    }

    public OverworldBiomeBuilder(OverworldBiomeBuilder.a overworldbiomebuilder_a) {
        this.FULL_RANGE = Climate.b.span(-1.0F, 1.0F);
        this.temperatures = new Climate.b[]{Climate.b.span(-1.0F, -0.45F), Climate.b.span(-0.45F, -0.15F), Climate.b.span(-0.15F, 0.2F), Climate.b.span(0.2F, 0.55F), Climate.b.span(0.55F, 1.0F)};
        this.humidities = new Climate.b[]{Climate.b.span(-1.0F, -0.35F), Climate.b.span(-0.35F, -0.1F), Climate.b.span(-0.1F, 0.1F), Climate.b.span(0.1F, 0.3F), Climate.b.span(0.3F, 1.0F)};
        this.erosions = new Climate.b[]{Climate.b.span(-1.0F, -0.78F), Climate.b.span(-0.78F, -0.375F), Climate.b.span(-0.375F, -0.2225F), Climate.b.span(-0.2225F, 0.05F), Climate.b.span(0.05F, 0.45F), Climate.b.span(0.45F, 0.55F), Climate.b.span(0.55F, 1.0F)};
        ...
        this.modifier = overworldbiomebuilder_a;
    }
    ...
    private void addDebugBiomes(Consumer<Pair<Climate.d, ResourceKey<BiomeBase>>> consumer) {
        HolderLookup.b holderlookup_b = VanillaRegistries.createLookup();
        HolderGetter<DensityFunction> holdergetter = holderlookup_b.lookupOrThrow(Registries.DENSITY_FUNCTION);
    ...
    private ResourceKey<BiomeBase> pickPlateauBiome(int i, int j, Climate.b climate_b) {
        ...
        return climate_b.max() >= 0L && resourcekey != null && (resourcekey != Biomes.CHERRY_GROVE || this.modifier == OverworldBiomeBuilder.a.UPDATE_1_20) ? resourcekey : this.PLATEAU_BIOMES[i][j];
    }
    ...
    public static boolean isDeepDarkRegion(DensityFunction densityfunction, DensityFunction densityfunction1, DensityFunction.b densityfunction_b) {
        return densityfunction.compute(densityfunction_b) < -0.22499999403953552D && densityfunction1.compute(densityfunction_b) > 0.8999999761581421D;
    }
