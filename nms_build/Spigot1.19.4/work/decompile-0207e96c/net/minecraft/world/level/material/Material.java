...
public final class Material {
    ...
    public static final Material FROGSPAWN = (new Material.a(MaterialMapColor.WATER)).noCollider().notSolidBlocking().nonSolid().destroyOnPush().build();
    public static final Material FROGLIGHT = (new Material.a(MaterialMapColor.NONE)).build();
    public static final Material DECORATED_POT = (new Material.a(MaterialMapColor.TERRACOTTA_RED)).destroyOnPush().build();
