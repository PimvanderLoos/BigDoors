...
public class DesertPyramidPiece extends WorldGenScatteredPiece {
    ...
    private void addCellarStairs(BlockPosition blockposition, GeneratorAccessSeed generatoraccessseed, StructureBoundingBox structureboundingbox) {
        ...
        this.placeBlock(generatoraccessseed, iblockdata.rotate(EnumBlockRotation.COUNTERCLOCKWISE_90), 12, 0, 17, structureboundingbox);
        ...
        this.placeBlock(generatoraccessseed, iblockdata1, i - 1, j + 3, k + 4, structureboundingbox);
        this.placeBlock(generatoraccessseed, iblockdata1, i, j + 3, k + 4, structureboundingbox);
        this.placeBlock(generatoraccessseed, iblockdata1, i - 1, j + 2, k + 4, structureboundingbox);
        this.placeBlock(generatoraccessseed, flag ? iblockdata1 : iblockdata2, i, j + 2, k + 4, structureboundingbox);
        this.placeBlock(generatoraccessseed, flag ? iblockdata1 : iblockdata2, i, j + 1, k + 4, structureboundingbox);
    }
    ...
    private void addCellarRoom(BlockPosition blockposition, GeneratorAccessSeed generatoraccessseed, StructureBoundingBox structureboundingbox) {
        ...
        this.placeSandBox(structureboundingbox, i - 2, j + 1, k - 2, i + 2, j + 3, k + 2);
        ...
        this.placeSand(i + 3, j + 1, k, structureboundingbox);
        this.placeSand(i + 3, j + 2, k, structureboundingbox);
        ...
        this.placeSand(i, j + 1, k + 3, structureboundingbox);
        this.placeSand(i, j + 2, k + 3, structureboundingbox);
        this.placeBlock(generatoraccessseed, iblockdata2, i, j, k - 3, structureboundingbox);
        this.placeSand(i, j + 1, k - 3, structureboundingbox);
        this.placeSand(i, j + 2, k - 3, structureboundingbox);
    ...
    private void placeSand(int i, int j, int k, StructureBoundingBox structureboundingbox) {
    ...
    private void placeSandBox(StructureBoundingBox structureboundingbox, int i, int j, int k, int l, int i1, int j1) {
        for (int k1 = j; k1 <= i1; ++k1) {
            for (int l1 = i; l1 <= l; ++l1) {
                for (int i2 = k; i2 <= j1; ++i2) {
                    this.placeSand(l1, k1, i2, structureboundingbox);
                }
            }
        }
    ...
    private void placeCollapsedRoofPiece(GeneratorAccessSeed generatoraccessseed, int i, int j, int k, StructureBoundingBox structureboundingbox) {
        ...
        if (generatoraccessseed.getRandom().nextBoolean()) {
