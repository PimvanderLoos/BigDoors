...
public class Blocks {
    ...
    public static final Block CHERRY_PLANKS = register("cherry_planks", new Block(BlockBase.Info.of(Material.WOOD, MaterialMapColor.TERRACOTTA_WHITE).strength(2.0F, 3.0F).sound(SoundEffectType.CHERRY_WOOD).requiredFeatures(FeatureFlags.UPDATE_1_20)));
    ...
    public static final Block BAMBOO_PLANKS = register("bamboo_planks", new Block(BlockBase.Info.of(Material.WOOD, MaterialMapColor.COLOR_YELLOW).strength(2.0F, 3.0F).sound(SoundEffectType.BAMBOO_WOOD).requiredFeatures(FeatureFlags.UPDATE_1_20)));
    public static final Block BAMBOO_MOSAIC = register("bamboo_mosaic", new Block(BlockBase.Info.of(Material.WOOD, MaterialMapColor.COLOR_YELLOW).strength(2.0F, 3.0F).sound(SoundEffectType.BAMBOO_WOOD).requiredFeatures(FeatureFlags.UPDATE_1_20)));
    ...
    public static final Block CHERRY_SAPLING = register("cherry_sapling", new BlockSapling(new CherryTreeGrower(), BlockBase.Info.of(Material.PLANT, MaterialMapColor.COLOR_PINK).noCollission().randomTicks().instabreak().sound(SoundEffectType.CHERRY_SAPLING).requiredFeatures(FeatureFlags.UPDATE_1_20)));
    ...
    public static final Block SUSPICIOUS_SAND = register("suspicious_sand", new SuspiciousSandBlock(BlockBase.Info.of(Material.SAND, MaterialMapColor.SAND).strength(0.25F).sound(SoundEffectType.SUSPICIOUS_SAND).requiredFeatures(FeatureFlags.UPDATE_1_20)));
    ...
    public static final Block CHERRY_LOG = register("cherry_log", log(MaterialMapColor.TERRACOTTA_WHITE, MaterialMapColor.TERRACOTTA_GRAY, SoundEffectType.CHERRY_WOOD, FeatureFlags.UPDATE_1_20));
    ...
    public static final Block BAMBOO_BLOCK = register("bamboo_block", log(MaterialMapColor.COLOR_YELLOW, MaterialMapColor.PLANT, SoundEffectType.BAMBOO_WOOD, FeatureFlags.UPDATE_1_20));
    ...
    public static final Block STRIPPED_CHERRY_LOG = register("stripped_cherry_log", log(MaterialMapColor.TERRACOTTA_WHITE, MaterialMapColor.TERRACOTTA_PINK, SoundEffectType.CHERRY_WOOD, FeatureFlags.UPDATE_1_20));
    ...
    public static final Block STRIPPED_BAMBOO_BLOCK = register("stripped_bamboo_block", log(MaterialMapColor.COLOR_YELLOW, MaterialMapColor.COLOR_YELLOW, SoundEffectType.BAMBOO_WOOD, FeatureFlags.UPDATE_1_20));
    ...
    public static final Block CHERRY_WOOD = register("cherry_wood", new BlockRotatable(BlockBase.Info.of(Material.WOOD, MaterialMapColor.TERRACOTTA_GRAY).strength(2.0F).sound(SoundEffectType.CHERRY_WOOD).requiredFeatures(FeatureFlags.UPDATE_1_20)));
    ...
    public static final Block STRIPPED_CHERRY_WOOD = register("stripped_cherry_wood", new BlockRotatable(BlockBase.Info.of(Material.WOOD, MaterialMapColor.TERRACOTTA_PINK).strength(2.0F).sound(SoundEffectType.CHERRY_WOOD).requiredFeatures(FeatureFlags.UPDATE_1_20)));
    ...
    public static final Block CHERRY_LEAVES = register("cherry_leaves", new CherryLeavesBlock(BlockBase.Info.of(Material.LEAVES, MaterialMapColor.COLOR_PINK).strength(0.2F).randomTicks().sound(SoundEffectType.CHERRY_LEAVES).noOcclusion().isValidSpawn(Blocks::ocelotOrParrot).isSuffocating(Blocks::never).isViewBlocking(Blocks::never).requiredFeatures(FeatureFlags.UPDATE_1_20)));
    ...
    public static final Block TORCHFLOWER = register("torchflower", new BlockFlowers(MobEffects.NIGHT_VISION, 5, BlockBase.Info.of(Material.PLANT).noCollission().instabreak().sound(SoundEffectType.GRASS).offsetType(BlockBase.EnumRandomOffset.XZ).requiredFeatures(FeatureFlags.UPDATE_1_20)));
    ...
    public static final Block RED_MUSHROOM = register("red_mushroom", new BlockMushroom(BlockBase.Info.of(Material.PLANT, MaterialMapColor.COLOR_RED).noCollission().randomTicks().instabreak().sound(SoundEffectType.GRASS).hasPostProcess(Blocks::always), TreeFeatures.HUGE_RED_MUSHROOM));
    ...
    public static final Block CHISELED_BOOKSHELF = register("chiseled_bookshelf", new ChiseledBookShelfBlock(BlockBase.Info.of(Material.WOOD).strength(1.5F).sound(SoundEffectType.CHISELED_BOOKSHELF).requiredFeatures(FeatureFlags.UPDATE_1_20)));
    ...
    public static final Block OAK_SIGN = register("oak_sign", new BlockFloorSign(BlockBase.Info.of(Material.WOOD).noCollission().strength(1.0F), BlockPropertyWood.OAK));
    public static final Block SPRUCE_SIGN = register("spruce_sign", new BlockFloorSign(BlockBase.Info.of(Material.WOOD, Blocks.SPRUCE_LOG.defaultMaterialColor()).noCollission().strength(1.0F), BlockPropertyWood.SPRUCE));
    public static final Block BIRCH_SIGN = register("birch_sign", new BlockFloorSign(BlockBase.Info.of(Material.WOOD, MaterialMapColor.SAND).noCollission().strength(1.0F), BlockPropertyWood.BIRCH));
    public static final Block ACACIA_SIGN = register("acacia_sign", new BlockFloorSign(BlockBase.Info.of(Material.WOOD, MaterialMapColor.COLOR_ORANGE).noCollission().strength(1.0F), BlockPropertyWood.ACACIA));
    public static final Block CHERRY_SIGN = register("cherry_sign", new BlockFloorSign(BlockBase.Info.of(Material.WOOD, Blocks.CHERRY_PLANKS.defaultMaterialColor()).noCollission().strength(1.0F).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.CHERRY));
    public static final Block JUNGLE_SIGN = register("jungle_sign", new BlockFloorSign(BlockBase.Info.of(Material.WOOD, Blocks.JUNGLE_LOG.defaultMaterialColor()).noCollission().strength(1.0F), BlockPropertyWood.JUNGLE));
    public static final Block DARK_OAK_SIGN = register("dark_oak_sign", new BlockFloorSign(BlockBase.Info.of(Material.WOOD, Blocks.DARK_OAK_LOG.defaultMaterialColor()).noCollission().strength(1.0F), BlockPropertyWood.DARK_OAK));
    public static final Block MANGROVE_SIGN = register("mangrove_sign", new BlockFloorSign(BlockBase.Info.of(Material.WOOD, Blocks.MANGROVE_LOG.defaultMaterialColor()).noCollission().strength(1.0F), BlockPropertyWood.MANGROVE));
    public static final Block BAMBOO_SIGN = register("bamboo_sign", new BlockFloorSign(BlockBase.Info.of(Material.WOOD, Blocks.BAMBOO_PLANKS.defaultMaterialColor()).noCollission().strength(1.0F).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.BAMBOO));
    public static final Block OAK_DOOR = register("oak_door", new BlockDoor(BlockBase.Info.of(Material.WOOD, Blocks.OAK_PLANKS.defaultMaterialColor()).strength(3.0F).noOcclusion(), BlockSetType.OAK));
    ...
    public static final Block OAK_WALL_SIGN = register("oak_wall_sign", new BlockWallSign(BlockBase.Info.of(Material.WOOD).noCollission().strength(1.0F).dropsLike(Blocks.OAK_SIGN), BlockPropertyWood.OAK));
    public static final Block SPRUCE_WALL_SIGN = register("spruce_wall_sign", new BlockWallSign(BlockBase.Info.of(Material.WOOD, Blocks.SPRUCE_LOG.defaultMaterialColor()).noCollission().strength(1.0F).dropsLike(Blocks.SPRUCE_SIGN), BlockPropertyWood.SPRUCE));
    public static final Block BIRCH_WALL_SIGN = register("birch_wall_sign", new BlockWallSign(BlockBase.Info.of(Material.WOOD, MaterialMapColor.SAND).noCollission().strength(1.0F).dropsLike(Blocks.BIRCH_SIGN), BlockPropertyWood.BIRCH));
    public static final Block ACACIA_WALL_SIGN = register("acacia_wall_sign", new BlockWallSign(BlockBase.Info.of(Material.WOOD, MaterialMapColor.COLOR_ORANGE).noCollission().strength(1.0F).dropsLike(Blocks.ACACIA_SIGN), BlockPropertyWood.ACACIA));
    public static final Block CHERRY_WALL_SIGN = register("cherry_wall_sign", new BlockWallSign(BlockBase.Info.of(Material.WOOD, Blocks.CHERRY_LOG.defaultMaterialColor()).noCollission().strength(1.0F).dropsLike(Blocks.CHERRY_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.CHERRY));
    public static final Block JUNGLE_WALL_SIGN = register("jungle_wall_sign", new BlockWallSign(BlockBase.Info.of(Material.WOOD, Blocks.JUNGLE_LOG.defaultMaterialColor()).noCollission().strength(1.0F).dropsLike(Blocks.JUNGLE_SIGN), BlockPropertyWood.JUNGLE));
    public static final Block DARK_OAK_WALL_SIGN = register("dark_oak_wall_sign", new BlockWallSign(BlockBase.Info.of(Material.WOOD, Blocks.DARK_OAK_LOG.defaultMaterialColor()).noCollission().strength(1.0F).dropsLike(Blocks.DARK_OAK_SIGN), BlockPropertyWood.DARK_OAK));
    public static final Block MANGROVE_WALL_SIGN = register("mangrove_wall_sign", new BlockWallSign(BlockBase.Info.of(Material.WOOD, Blocks.MANGROVE_LOG.defaultMaterialColor()).noCollission().strength(1.0F).dropsLike(Blocks.MANGROVE_SIGN), BlockPropertyWood.MANGROVE));
    public static final Block BAMBOO_WALL_SIGN = register("bamboo_wall_sign", new BlockWallSign(BlockBase.Info.of(Material.WOOD, Blocks.BAMBOO_PLANKS.defaultMaterialColor()).noCollission().strength(1.0F).requiredFeatures(FeatureFlags.UPDATE_1_20).dropsLike(Blocks.BAMBOO_SIGN), BlockPropertyWood.BAMBOO));
    public static final Block OAK_HANGING_SIGN = register("oak_hanging_sign", new CeilingHangingSignBlock(BlockBase.Info.of(Material.WOOD, Blocks.OAK_LOG.defaultMaterialColor()).noCollission().strength(1.0F).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.OAK));
    public static final Block SPRUCE_HANGING_SIGN = register("spruce_hanging_sign", new CeilingHangingSignBlock(BlockBase.Info.of(Material.WOOD, Blocks.SPRUCE_LOG.defaultMaterialColor()).noCollission().strength(1.0F).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.SPRUCE));
    public static final Block BIRCH_HANGING_SIGN = register("birch_hanging_sign", new CeilingHangingSignBlock(BlockBase.Info.of(Material.WOOD, MaterialMapColor.SAND).noCollission().strength(1.0F).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.BIRCH));
    public static final Block ACACIA_HANGING_SIGN = register("acacia_hanging_sign", new CeilingHangingSignBlock(BlockBase.Info.of(Material.WOOD, MaterialMapColor.COLOR_ORANGE).noCollission().strength(1.0F).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.ACACIA));
    public static final Block CHERRY_HANGING_SIGN = register("cherry_hanging_sign", new CeilingHangingSignBlock(BlockBase.Info.of(Material.WOOD, MaterialMapColor.TERRACOTTA_PINK).noCollission().strength(1.0F).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.CHERRY));
    public static final Block JUNGLE_HANGING_SIGN = register("jungle_hanging_sign", new CeilingHangingSignBlock(BlockBase.Info.of(Material.WOOD, Blocks.JUNGLE_LOG.defaultMaterialColor()).noCollission().strength(1.0F).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.JUNGLE));
    public static final Block DARK_OAK_HANGING_SIGN = register("dark_oak_hanging_sign", new CeilingHangingSignBlock(BlockBase.Info.of(Material.WOOD, Blocks.DARK_OAK_LOG.defaultMaterialColor()).noCollission().strength(1.0F).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.DARK_OAK));
    public static final Block CRIMSON_HANGING_SIGN = register("crimson_hanging_sign", new CeilingHangingSignBlock(BlockBase.Info.of(Material.WOOD, MaterialMapColor.CRIMSON_STEM).noCollission().strength(1.0F).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.CRIMSON));
    public static final Block WARPED_HANGING_SIGN = register("warped_hanging_sign", new CeilingHangingSignBlock(BlockBase.Info.of(Material.WOOD, MaterialMapColor.WARPED_STEM).noCollission().strength(1.0F).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.WARPED));
    public static final Block MANGROVE_HANGING_SIGN = register("mangrove_hanging_sign", new CeilingHangingSignBlock(BlockBase.Info.of(Material.WOOD, Blocks.MANGROVE_LOG.defaultMaterialColor()).noCollission().strength(1.0F).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.MANGROVE));
    public static final Block BAMBOO_HANGING_SIGN = register("bamboo_hanging_sign", new CeilingHangingSignBlock(BlockBase.Info.of(Material.WOOD, MaterialMapColor.COLOR_YELLOW).noCollission().strength(1.0F).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.BAMBOO));
    public static final Block OAK_WALL_HANGING_SIGN = register("oak_wall_hanging_sign", new WallHangingSignBlock(BlockBase.Info.of(Material.WOOD, Blocks.OAK_LOG.defaultMaterialColor()).noCollission().strength(1.0F).requiredFeatures(FeatureFlags.UPDATE_1_20).dropsLike(Blocks.OAK_HANGING_SIGN), BlockPropertyWood.OAK));
    public static final Block SPRUCE_WALL_HANGING_SIGN = register("spruce_wall_hanging_sign", new WallHangingSignBlock(BlockBase.Info.of(Material.WOOD).noCollission().strength(1.0F).dropsLike(Blocks.SPRUCE_HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.SPRUCE));
    public static final Block BIRCH_WALL_HANGING_SIGN = register("birch_wall_hanging_sign", new WallHangingSignBlock(BlockBase.Info.of(Material.SAND).noCollission().strength(1.0F).dropsLike(Blocks.BIRCH_HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.BIRCH));
    public static final Block ACACIA_WALL_HANGING_SIGN = register("acacia_wall_hanging_sign", new WallHangingSignBlock(BlockBase.Info.of(Material.WOOD, MaterialMapColor.COLOR_ORANGE).noCollission().strength(1.0F).dropsLike(Blocks.ACACIA_HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.ACACIA));
    public static final Block CHERRY_WALL_HANGING_SIGN = register("cherry_wall_hanging_sign", new WallHangingSignBlock(BlockBase.Info.of(Material.WOOD, MaterialMapColor.TERRACOTTA_PINK).noCollission().strength(1.0F).dropsLike(Blocks.CHERRY_HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.CHERRY));
    public static final Block JUNGLE_WALL_HANGING_SIGN = register("jungle_wall_hanging_sign", new WallHangingSignBlock(BlockBase.Info.of(Material.WOOD, Blocks.JUNGLE_LOG.defaultMaterialColor()).noCollission().strength(1.0F).dropsLike(Blocks.JUNGLE_HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.JUNGLE));
    public static final Block DARK_OAK_WALL_HANGING_SIGN = register("dark_oak_wall_hanging_sign", new WallHangingSignBlock(BlockBase.Info.of(Material.WOOD, Blocks.DARK_OAK_LOG.defaultMaterialColor()).noCollission().strength(1.0F).dropsLike(Blocks.DARK_OAK_HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.DARK_OAK));
    public static final Block MANGROVE_WALL_HANGING_SIGN = register("mangrove_wall_hanging_sign", new WallHangingSignBlock(BlockBase.Info.of(Material.WOOD, Blocks.MANGROVE_LOG.defaultMaterialColor()).noCollission().strength(1.0F).dropsLike(Blocks.MANGROVE_HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.MANGROVE));
    public static final Block CRIMSON_WALL_HANGING_SIGN = register("crimson_wall_hanging_sign", new WallHangingSignBlock(BlockBase.Info.of(Material.WOOD, MaterialMapColor.CRIMSON_STEM).noCollission().strength(1.0F).dropsLike(Blocks.CRIMSON_HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.CRIMSON));
    public static final Block WARPED_WALL_HANGING_SIGN = register("warped_wall_hanging_sign", new WallHangingSignBlock(BlockBase.Info.of(Material.WOOD, MaterialMapColor.WARPED_STEM).noCollission().strength(1.0F).dropsLike(Blocks.WARPED_HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.WARPED));
    public static final Block BAMBOO_WALL_HANGING_SIGN = register("bamboo_wall_hanging_sign", new WallHangingSignBlock(BlockBase.Info.of(Material.WOOD, MaterialMapColor.COLOR_YELLOW).noCollission().strength(1.0F).dropsLike(Blocks.BAMBOO_HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.BAMBOO));
    ...
    public static final Block STONE_PRESSURE_PLATE = register("stone_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.MOBS, BlockBase.Info.of(Material.STONE).requiresCorrectToolForDrops().noCollission().strength(0.5F), BlockSetType.STONE));
    public static final Block IRON_DOOR = register("iron_door", new BlockDoor(BlockBase.Info.of(Material.METAL, MaterialMapColor.METAL).requiresCorrectToolForDrops().strength(5.0F).noOcclusion(), BlockSetType.IRON));
    public static final Block OAK_PRESSURE_PLATE = register("oak_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of(Material.WOOD, Blocks.OAK_PLANKS.defaultMaterialColor()).noCollission().strength(0.5F), BlockSetType.OAK));
    public static final Block SPRUCE_PRESSURE_PLATE = register("spruce_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of(Material.WOOD, Blocks.SPRUCE_PLANKS.defaultMaterialColor()).noCollission().strength(0.5F), BlockSetType.SPRUCE));
    public static final Block BIRCH_PRESSURE_PLATE = register("birch_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of(Material.WOOD, Blocks.BIRCH_PLANKS.defaultMaterialColor()).noCollission().strength(0.5F), BlockSetType.BIRCH));
    public static final Block JUNGLE_PRESSURE_PLATE = register("jungle_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of(Material.WOOD, Blocks.JUNGLE_PLANKS.defaultMaterialColor()).noCollission().strength(0.5F), BlockSetType.JUNGLE));
    public static final Block ACACIA_PRESSURE_PLATE = register("acacia_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of(Material.WOOD, Blocks.ACACIA_PLANKS.defaultMaterialColor()).noCollission().strength(0.5F), BlockSetType.ACACIA));
    public static final Block CHERRY_PRESSURE_PLATE = register("cherry_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of(Material.WOOD, Blocks.CHERRY_PLANKS.defaultMaterialColor()).noCollission().strength(0.5F).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockSetType.CHERRY));
    public static final Block DARK_OAK_PRESSURE_PLATE = register("dark_oak_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of(Material.WOOD, Blocks.DARK_OAK_PLANKS.defaultMaterialColor()).noCollission().strength(0.5F), BlockSetType.DARK_OAK));
    public static final Block MANGROVE_PRESSURE_PLATE = register("mangrove_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of(Material.WOOD, Blocks.MANGROVE_PLANKS.defaultMaterialColor()).noCollission().strength(0.5F), BlockSetType.MANGROVE));
    public static final Block BAMBOO_PRESSURE_PLATE = register("bamboo_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of(Material.WOOD, Blocks.BAMBOO_PLANKS.defaultMaterialColor()).noCollission().strength(0.5F).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockSetType.BAMBOO));
    ...
    public static final Block OAK_TRAPDOOR = register("oak_trapdoor", new BlockTrapdoor(BlockBase.Info.of(Material.WOOD, MaterialMapColor.WOOD).strength(3.0F).noOcclusion().isValidSpawn(Blocks::never), BlockSetType.OAK));
    public static final Block SPRUCE_TRAPDOOR = register("spruce_trapdoor", new BlockTrapdoor(BlockBase.Info.of(Material.WOOD, MaterialMapColor.PODZOL).strength(3.0F).noOcclusion().isValidSpawn(Blocks::never), BlockSetType.SPRUCE));
    public static final Block BIRCH_TRAPDOOR = register("birch_trapdoor", new BlockTrapdoor(BlockBase.Info.of(Material.WOOD, MaterialMapColor.SAND).strength(3.0F).noOcclusion().isValidSpawn(Blocks::never), BlockSetType.BIRCH));
    public static final Block JUNGLE_TRAPDOOR = register("jungle_trapdoor", new BlockTrapdoor(BlockBase.Info.of(Material.WOOD, MaterialMapColor.DIRT).strength(3.0F).noOcclusion().isValidSpawn(Blocks::never), BlockSetType.JUNGLE));
    public static final Block ACACIA_TRAPDOOR = register("acacia_trapdoor", new BlockTrapdoor(BlockBase.Info.of(Material.WOOD, MaterialMapColor.COLOR_ORANGE).strength(3.0F).noOcclusion().isValidSpawn(Blocks::never), BlockSetType.ACACIA));
    public static final Block CHERRY_TRAPDOOR = register("cherry_trapdoor", new BlockTrapdoor(BlockBase.Info.of(Material.WOOD, MaterialMapColor.TERRACOTTA_WHITE).strength(3.0F).noOcclusion().isValidSpawn(Blocks::never).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockSetType.CHERRY));
    public static final Block DARK_OAK_TRAPDOOR = register("dark_oak_trapdoor", new BlockTrapdoor(BlockBase.Info.of(Material.WOOD, MaterialMapColor.COLOR_BROWN).strength(3.0F).noOcclusion().isValidSpawn(Blocks::never), BlockSetType.DARK_OAK));
    public static final Block MANGROVE_TRAPDOOR = register("mangrove_trapdoor", new BlockTrapdoor(BlockBase.Info.of(Material.WOOD, MaterialMapColor.COLOR_RED).strength(3.0F).noOcclusion().isValidSpawn(Blocks::never), BlockSetType.MANGROVE));
    public static final Block BAMBOO_TRAPDOOR = register("bamboo_trapdoor", new BlockTrapdoor(BlockBase.Info.of(Material.WOOD, MaterialMapColor.COLOR_YELLOW).strength(3.0F).noOcclusion().isValidSpawn(Blocks::never).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockSetType.BAMBOO));
    ...
    public static final Block OAK_FENCE_GATE = register("oak_fence_gate", new BlockFenceGate(BlockBase.Info.of(Material.WOOD, Blocks.OAK_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F), BlockPropertyWood.OAK));
    ...
    public static final Block POTTED_TORCHFLOWER = register("potted_torchflower", new BlockFlowerPot(Blocks.TORCHFLOWER, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion().requiredFeatures(FeatureFlags.UPDATE_1_20)));
    ...
    public static final Block POTTED_CHERRY_SAPLING = register("potted_cherry_sapling", new BlockFlowerPot(Blocks.CHERRY_SAPLING, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion().requiredFeatures(FeatureFlags.UPDATE_1_20)));
    ...
    public static final Block CHERRY_BUTTON = register("cherry_button", new BlockButtonAbstract(BlockBase.Info.of(Material.DECORATION).noCollission().strength(0.5F).sound(SoundEffectType.CHERRY_WOOD).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockSetType.CHERRY, 30, true));
    ...
    public static final Block BAMBOO_BUTTON = register("bamboo_button", new BlockButtonAbstract(BlockBase.Info.of(Material.DECORATION).noCollission().strength(0.5F).sound(SoundEffectType.BAMBOO_WOOD).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockSetType.BAMBOO, 30, true));
    ...
    public static final Block PIGLIN_HEAD = register("piglin_head", new BlockSkull(BlockSkull.Type.PIGLIN, BlockBase.Info.of(Material.DECORATION).strength(1.0F).requiredFeatures(FeatureFlags.UPDATE_1_20)));
    public static final Block PIGLIN_WALL_HEAD = register("piglin_wall_head", new PiglinWallSkullBlock(BlockBase.Info.of(Material.DECORATION).strength(1.0F).dropsLike(Blocks.PIGLIN_HEAD).requiredFeatures(FeatureFlags.UPDATE_1_20)));
    ...
    public static final Block LIGHT_WEIGHTED_PRESSURE_PLATE = register("light_weighted_pressure_plate", new BlockPressurePlateWeighted(15, BlockBase.Info.of(Material.METAL, MaterialMapColor.GOLD).requiresCorrectToolForDrops().noCollission().strength(0.5F), BlockSetType.GOLD));
    public static final Block HEAVY_WEIGHTED_PRESSURE_PLATE = register("heavy_weighted_pressure_plate", new BlockPressurePlateWeighted(150, BlockBase.Info.of(Material.METAL).requiresCorrectToolForDrops().noCollission().strength(0.5F), BlockSetType.IRON));
    ...
    public static final Block CHERRY_STAIRS = register("cherry_stairs", new BlockStairs(Blocks.CHERRY_PLANKS.defaultBlockState(), BlockBase.Info.copy(Blocks.CHERRY_PLANKS)));
    ...
    public static final Block BAMBOO_STAIRS = register("bamboo_stairs", new BlockStairs(Blocks.BAMBOO_PLANKS.defaultBlockState(), BlockBase.Info.copy(Blocks.BAMBOO_PLANKS)));
    public static final Block BAMBOO_MOSAIC_STAIRS = register("bamboo_mosaic_stairs", new BlockStairs(Blocks.BAMBOO_MOSAIC.defaultBlockState(), BlockBase.Info.copy(Blocks.BAMBOO_MOSAIC)));
    ...
    public static final Block BARRIER = register("barrier", new BlockBarrier(BlockBase.Info.of(Material.BARRIER).strength(-1.0F, 3600000.8F).noLootTable().noOcclusion().isValidSpawn(Blocks::never).noParticlesOnBreak()));
    ...
    public static final Block IRON_TRAPDOOR = register("iron_trapdoor", new BlockTrapdoor(BlockBase.Info.of(Material.METAL).requiresCorrectToolForDrops().strength(5.0F).noOcclusion().isValidSpawn(Blocks::never), BlockSetType.IRON));
    ...
    public static final Block CHERRY_SLAB = register("cherry_slab", new BlockStepAbstract(BlockBase.Info.of(Material.WOOD, MaterialMapColor.TERRACOTTA_WHITE).strength(2.0F, 3.0F).sound(SoundEffectType.CHERRY_WOOD).requiredFeatures(FeatureFlags.UPDATE_1_20)));
    ...
    public static final Block BAMBOO_SLAB = register("bamboo_slab", new BlockStepAbstract(BlockBase.Info.of(Material.WOOD, MaterialMapColor.COLOR_YELLOW).strength(2.0F, 3.0F).sound(SoundEffectType.BAMBOO_WOOD).requiredFeatures(FeatureFlags.UPDATE_1_20)));
    public static final Block BAMBOO_MOSAIC_SLAB = register("bamboo_mosaic_slab", new BlockStepAbstract(BlockBase.Info.of(Material.WOOD, MaterialMapColor.COLOR_YELLOW).strength(2.0F, 3.0F).sound(SoundEffectType.BAMBOO_WOOD).requiredFeatures(FeatureFlags.UPDATE_1_20)));
    ...
    public static final Block MUD_BRICK_SLAB = register("mud_brick_slab", new BlockStepAbstract(BlockBase.Info.of(Material.STONE, MaterialMapColor.TERRACOTTA_LIGHT_GRAY).requiresCorrectToolForDrops().strength(1.5F, 3.0F).sound(SoundEffectType.MUD_BRICKS)));
    ...
    public static final Block SPRUCE_FENCE_GATE = register("spruce_fence_gate", new BlockFenceGate(BlockBase.Info.of(Material.WOOD, Blocks.SPRUCE_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F), BlockPropertyWood.SPRUCE));
    public static final Block BIRCH_FENCE_GATE = register("birch_fence_gate", new BlockFenceGate(BlockBase.Info.of(Material.WOOD, Blocks.BIRCH_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F), BlockPropertyWood.BIRCH));
    public static final Block JUNGLE_FENCE_GATE = register("jungle_fence_gate", new BlockFenceGate(BlockBase.Info.of(Material.WOOD, Blocks.JUNGLE_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F), BlockPropertyWood.JUNGLE));
    public static final Block ACACIA_FENCE_GATE = register("acacia_fence_gate", new BlockFenceGate(BlockBase.Info.of(Material.WOOD, Blocks.ACACIA_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F), BlockPropertyWood.ACACIA));
    public static final Block CHERRY_FENCE_GATE = register("cherry_fence_gate", new BlockFenceGate(BlockBase.Info.of(Material.WOOD, Blocks.CHERRY_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.CHERRY));
    public static final Block DARK_OAK_FENCE_GATE = register("dark_oak_fence_gate", new BlockFenceGate(BlockBase.Info.of(Material.WOOD, Blocks.DARK_OAK_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F), BlockPropertyWood.DARK_OAK));
    public static final Block MANGROVE_FENCE_GATE = register("mangrove_fence_gate", new BlockFenceGate(BlockBase.Info.of(Material.WOOD, Blocks.MANGROVE_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F), BlockPropertyWood.MANGROVE));
    public static final Block BAMBOO_FENCE_GATE = register("bamboo_fence_gate", new BlockFenceGate(BlockBase.Info.of(Material.WOOD, Blocks.BAMBOO_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.BAMBOO));
    ...
    public static final Block CHERRY_FENCE = register("cherry_fence", new BlockFence(BlockBase.Info.of(Material.WOOD, Blocks.CHERRY_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.CHERRY_WOOD).requiredFeatures(FeatureFlags.UPDATE_1_20)));
    ...
    public static final Block BAMBOO_FENCE = register("bamboo_fence", new BlockFence(BlockBase.Info.of(Material.WOOD, Blocks.BAMBOO_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.BAMBOO_WOOD).requiredFeatures(FeatureFlags.UPDATE_1_20)));
    public static final Block SPRUCE_DOOR = register("spruce_door", new BlockDoor(BlockBase.Info.of(Material.WOOD, Blocks.SPRUCE_PLANKS.defaultMaterialColor()).strength(3.0F).noOcclusion(), BlockSetType.SPRUCE));
    public static final Block BIRCH_DOOR = register("birch_door", new BlockDoor(BlockBase.Info.of(Material.WOOD, Blocks.BIRCH_PLANKS.defaultMaterialColor()).strength(3.0F).noOcclusion(), BlockSetType.BIRCH));
    public static final Block JUNGLE_DOOR = register("jungle_door", new BlockDoor(BlockBase.Info.of(Material.WOOD, Blocks.JUNGLE_PLANKS.defaultMaterialColor()).strength(3.0F).noOcclusion(), BlockSetType.JUNGLE));
    public static final Block ACACIA_DOOR = register("acacia_door", new BlockDoor(BlockBase.Info.of(Material.WOOD, Blocks.ACACIA_PLANKS.defaultMaterialColor()).strength(3.0F).noOcclusion(), BlockSetType.ACACIA));
    public static final Block CHERRY_DOOR = register("cherry_door", new BlockDoor(BlockBase.Info.of(Material.WOOD, Blocks.CHERRY_PLANKS.defaultMaterialColor()).strength(3.0F).noOcclusion().requiredFeatures(FeatureFlags.UPDATE_1_20), BlockSetType.CHERRY));
    public static final Block DARK_OAK_DOOR = register("dark_oak_door", new BlockDoor(BlockBase.Info.of(Material.WOOD, Blocks.DARK_OAK_PLANKS.defaultMaterialColor()).strength(3.0F).noOcclusion(), BlockSetType.DARK_OAK));
    public static final Block MANGROVE_DOOR = register("mangrove_door", new BlockDoor(BlockBase.Info.of(Material.WOOD, Blocks.MANGROVE_PLANKS.defaultMaterialColor()).strength(3.0F).noOcclusion(), BlockSetType.MANGROVE));
    public static final Block BAMBOO_DOOR = register("bamboo_door", new BlockDoor(BlockBase.Info.of(Material.WOOD, Blocks.BAMBOO_PLANKS.defaultMaterialColor()).strength(3.0F).noOcclusion().requiredFeatures(FeatureFlags.UPDATE_1_20), BlockSetType.BAMBOO));
    ...
    public static final Block CHORUS_FLOWER = register("chorus_flower", new BlockChorusFlower((BlockChorusFruit) Blocks.CHORUS_PLANT, BlockBase.Info.of(Material.PLANT, MaterialMapColor.COLOR_PURPLE).randomTicks().strength(0.4F).sound(SoundEffectType.WOOD).noOcclusion().isValidSpawn(Blocks::never)));
    ...
    public static final Block TORCHFLOWER_CROP = register("torchflower_crop", new TorchflowerCropBlock(BlockBase.Info.of(Material.PLANT).noCollission().randomTicks().instabreak().sound(SoundEffectType.CROP).requiredFeatures(FeatureFlags.UPDATE_1_20)));
    ...
    public static final Block STRUCTURE_VOID = register("structure_void", new BlockStructureVoid(BlockBase.Info.of(Material.STRUCTURAL_AIR).noCollission().noLootTable().noParticlesOnBreak()));
    ...
    public static final Block SCAFFOLDING = register("scaffolding", new BlockScaffolding(BlockBase.Info.of(Material.DECORATION, MaterialMapColor.SAND).noCollission().sound(SoundEffectType.SCAFFOLDING).dynamicShape().isValidSpawn(Blocks::never)));
    ...
    public static final Block WARPED_FUNGUS = register("warped_fungus", new BlockFungi(BlockBase.Info.of(Material.PLANT, MaterialMapColor.COLOR_CYAN).instabreak().noCollission().sound(SoundEffectType.FUNGUS), TreeFeatures.WARPED_FUNGUS_PLANTED, Blocks.WARPED_NYLIUM));
    ...
    public static final Block CRIMSON_FUNGUS = register("crimson_fungus", new BlockFungi(BlockBase.Info.of(Material.PLANT, MaterialMapColor.NETHER).instabreak().noCollission().sound(SoundEffectType.FUNGUS), TreeFeatures.CRIMSON_FUNGUS_PLANTED, Blocks.CRIMSON_NYLIUM));
    ...
    public static final Block CRIMSON_PLANKS = register("crimson_planks", new Block(BlockBase.Info.of(Material.NETHER_WOOD, MaterialMapColor.CRIMSON_STEM).strength(2.0F, 3.0F).sound(SoundEffectType.NETHER_WOOD)));
    public static final Block WARPED_PLANKS = register("warped_planks", new Block(BlockBase.Info.of(Material.NETHER_WOOD, MaterialMapColor.WARPED_STEM).strength(2.0F, 3.0F).sound(SoundEffectType.NETHER_WOOD)));
    public static final Block CRIMSON_SLAB = register("crimson_slab", new BlockStepAbstract(BlockBase.Info.of(Material.NETHER_WOOD, Blocks.CRIMSON_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.NETHER_WOOD)));
    public static final Block WARPED_SLAB = register("warped_slab", new BlockStepAbstract(BlockBase.Info.of(Material.NETHER_WOOD, Blocks.WARPED_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.NETHER_WOOD)));
    public static final Block CRIMSON_PRESSURE_PLATE = register("crimson_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of(Material.NETHER_WOOD, Blocks.CRIMSON_PLANKS.defaultMaterialColor()).noCollission().strength(0.5F), BlockSetType.CRIMSON));
    public static final Block WARPED_PRESSURE_PLATE = register("warped_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of(Material.NETHER_WOOD, Blocks.WARPED_PLANKS.defaultMaterialColor()).noCollission().strength(0.5F), BlockSetType.WARPED));
    public static final Block CRIMSON_FENCE = register("crimson_fence", new BlockFence(BlockBase.Info.of(Material.NETHER_WOOD, Blocks.CRIMSON_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.NETHER_WOOD)));
    public static final Block WARPED_FENCE = register("warped_fence", new BlockFence(BlockBase.Info.of(Material.NETHER_WOOD, Blocks.WARPED_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.NETHER_WOOD)));
    public static final Block CRIMSON_TRAPDOOR = register("crimson_trapdoor", new BlockTrapdoor(BlockBase.Info.of(Material.NETHER_WOOD, Blocks.CRIMSON_PLANKS.defaultMaterialColor()).strength(3.0F).noOcclusion().isValidSpawn(Blocks::never), BlockSetType.CRIMSON));
    public static final Block WARPED_TRAPDOOR = register("warped_trapdoor", new BlockTrapdoor(BlockBase.Info.of(Material.NETHER_WOOD, Blocks.WARPED_PLANKS.defaultMaterialColor()).strength(3.0F).noOcclusion().isValidSpawn(Blocks::never), BlockSetType.WARPED));
    public static final Block CRIMSON_FENCE_GATE = register("crimson_fence_gate", new BlockFenceGate(BlockBase.Info.of(Material.NETHER_WOOD, Blocks.CRIMSON_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F), BlockPropertyWood.CRIMSON));
    public static final Block WARPED_FENCE_GATE = register("warped_fence_gate", new BlockFenceGate(BlockBase.Info.of(Material.NETHER_WOOD, Blocks.WARPED_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F), BlockPropertyWood.WARPED));
    ...
    public static final Block CRIMSON_DOOR = register("crimson_door", new BlockDoor(BlockBase.Info.of(Material.NETHER_WOOD, Blocks.CRIMSON_PLANKS.defaultMaterialColor()).strength(3.0F).noOcclusion(), BlockSetType.CRIMSON));
    public static final Block WARPED_DOOR = register("warped_door", new BlockDoor(BlockBase.Info.of(Material.NETHER_WOOD, Blocks.WARPED_PLANKS.defaultMaterialColor()).strength(3.0F).noOcclusion(), BlockSetType.WARPED));
    public static final Block CRIMSON_SIGN = register("crimson_sign", new BlockFloorSign(BlockBase.Info.of(Material.NETHER_WOOD, Blocks.CRIMSON_PLANKS.defaultMaterialColor()).noCollission().strength(1.0F), BlockPropertyWood.CRIMSON));
    public static final Block WARPED_SIGN = register("warped_sign", new BlockFloorSign(BlockBase.Info.of(Material.NETHER_WOOD, Blocks.WARPED_PLANKS.defaultMaterialColor()).noCollission().strength(1.0F), BlockPropertyWood.WARPED));
    public static final Block CRIMSON_WALL_SIGN = register("crimson_wall_sign", new BlockWallSign(BlockBase.Info.of(Material.NETHER_WOOD, Blocks.CRIMSON_PLANKS.defaultMaterialColor()).noCollission().strength(1.0F).dropsLike(Blocks.CRIMSON_SIGN), BlockPropertyWood.CRIMSON));
    public static final Block WARPED_WALL_SIGN = register("warped_wall_sign", new BlockWallSign(BlockBase.Info.of(Material.NETHER_WOOD, Blocks.WARPED_PLANKS.defaultMaterialColor()).noCollission().strength(1.0F).dropsLike(Blocks.WARPED_SIGN), BlockPropertyWood.WARPED));
    ...
    public static final Block PINK_PETALS = register("pink_petals", new PinkPetalsBlock(BlockBase.Info.of(Material.PLANT).noCollission().sound(SoundEffectType.PINK_PETALS).requiredFeatures(FeatureFlags.UPDATE_1_20)));
    ...
    public static final Block DECORATED_POT = register("decorated_pot", new DecoratedPotBlock(BlockBase.Info.of(Material.DECORATED_POT).strength(0.0F, 0.0F).sound(SoundEffectType.DECORATED_POT).requiredFeatures(FeatureFlags.UPDATE_1_20).noOcclusion()));
    ...
    private static BlockRotatable log(MaterialMapColor materialmapcolor, MaterialMapColor materialmapcolor1, SoundEffectType soundeffecttype, FeatureFlag... afeatureflag) {
        return new BlockRotatable(BlockBase.Info.of(Material.WOOD, (iblockdata) -> {
            return iblockdata.getValue(BlockRotatable.AXIS) == EnumDirection.EnumAxis.Y ? materialmapcolor : materialmapcolor1;
        }).strength(2.0F).sound(soundeffecttype).requiredFeatures(afeatureflag));
    }
    ...
    private static BlockShulkerBox shulkerBox(EnumColor enumcolor, BlockBase.Info blockbase_info) {
        ...
        return new BlockShulkerBox(enumcolor, blockbase_info.strength(2.0F).dynamicShape().noOcclusion().isSuffocating(blockbase_f).isViewBlocking(blockbase_f));
    }
    ...
    private static BlockPiston pistonBase(boolean flag) {
        ...
        return new BlockPiston(flag, BlockBase.Info.of(Material.PISTON).strength(1.5F).isRedstoneConductor(Blocks::never).isSuffocating(blockbase_f).isViewBlocking(blockbase_f));
    }

    private static BlockButtonAbstract woodenButton(BlockSetType blocksettype) {
        return new BlockButtonAbstract(BlockBase.Info.of(Material.DECORATION).noCollission().strength(0.5F), blocksettype, 30, true);
    }

    private static BlockButtonAbstract stoneButton() {
        return new BlockButtonAbstract(BlockBase.Info.of(Material.DECORATION).noCollission().strength(0.5F), BlockSetType.STONE, 20, false);
    }
