...
public class ContainerPlayer extends ContainerRecipeBook<InventoryCrafting> {
    ...
    public ContainerPlayer(PlayerInventory playerinventory, boolean flag, final EntityHuman entityhuman) {
        ...
        for (i = 0; i < 4; ++i) {
            ...
            this.addSlot(new Slot(playerinventory, 39 - i, 8, 8 + i * 18) {
                ...
                public void setByPlayer(ItemStack itemstack) {
                    ContainerPlayer.onEquipItem(entityhuman, enumitemslot, itemstack, this.getItem());
        ...
        this.addSlot(new Slot(playerinventory, 40, 77, 62) {
            @Override
            public void setByPlayer(ItemStack itemstack) {
                ContainerPlayer.onEquipItem(entityhuman, EnumItemSlot.OFFHAND, itemstack, this.getItem());
                super.setByPlayer(itemstack);
            }
    ...
    static void onEquipItem(EntityHuman entityhuman, EnumItemSlot enumitemslot, ItemStack itemstack, ItemStack itemstack1) {
        Equipable equipable = Equipable.get(itemstack);

        if (equipable != null) {
            entityhuman.onEquipItem(enumitemslot, itemstack1, itemstack);
        }
