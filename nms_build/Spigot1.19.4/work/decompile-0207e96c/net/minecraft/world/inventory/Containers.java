...
public class Containers<T extends Container> implements FeatureElement {
    ...
    public static final Containers<LegacySmithingMenu> LEGACY_SMITHING = register("legacy_smithing", LegacySmithingMenu::new);
    public static final Containers<ContainerSmithing> SMITHING = register("smithing", ContainerSmithing::new, FeatureFlags.UPDATE_1_20);
