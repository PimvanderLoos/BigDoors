...
public class ShapedRecipes implements RecipeCrafting {
    ...
    public ShapedRecipes(MinecraftKey minecraftkey, String s, CraftingBookCategory craftingbookcategory, int i, int j, NonNullList<RecipeItemStack> nonnulllist, ItemStack itemstack, boolean flag) {
    ...
    public static Item itemFromJson(JsonObject jsonobject) {
        ...
        Item item = (Item) BuiltInRegistries.ITEM.getOptional(new MinecraftKey(s)).orElseThrow(() -> {
    ...
    public static class a implements RecipeSerializer<ShapedRecipes> {
        ...
        public ShapedRecipes fromJson(MinecraftKey minecraftkey, JsonObject jsonobject) {
            ...
            boolean flag = ChatDeserializer.getAsBoolean(jsonobject, "show_notification", true);
