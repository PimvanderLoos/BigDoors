...
public class EntityZoglin extends EntityMonster implements IMonster, IOglin {
    ...
    private static void initIdleActivity(BehaviorController<EntityZoglin> behaviorcontroller) {
        behaviorcontroller.addActivity(Activity.IDLE, 10, ImmutableList.of(BehaviorAttackTargetSet.create(EntityZoglin::findNearestValidAttackTarget), SetEntityLookTargetSometimes.create(8.0F, UniformInt.of(30, 60)), new BehaviorGateSingle<>(ImmutableList.of(Pair.of(BehaviorStrollRandomUnconstrained.stroll(0.4F), 2), Pair.of(BehaviorLookWalk.create(0.4F, 3), 2), Pair.of(new BehaviorNop(30, 60), 1)))));
    }
