...
public class EntityTypes<T extends Entity> implements FeatureElement, EntityTypeTest<Entity, T> {
    ...
    public static final EntityTypes<Camel> CAMEL = register("camel", EntityTypes.Builder.of(Camel::new, EnumCreatureType.CREATURE).sized(1.7F, 2.375F).clientTrackingRange(10).requiredFeatures(FeatureFlags.UPDATE_1_20));
    ...
    public static final EntityTypes<Sniffer> SNIFFER = register("sniffer", EntityTypes.Builder.of(Sniffer::new, EnumCreatureType.CREATURE).sized(1.9F, 1.75F).clientTrackingRange(10).requiredFeatures(FeatureFlags.UPDATE_1_20));
