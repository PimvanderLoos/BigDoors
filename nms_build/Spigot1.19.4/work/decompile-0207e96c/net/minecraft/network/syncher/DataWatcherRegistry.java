...
public class DataWatcherRegistry {
    ...
    public static final DataWatcherSerializer<ParticleParam> PARTICLE = new DataWatcherSerializer.a<ParticleParam>() {
        ...
        public ParticleParam read(PacketDataSerializer packetdataserializer) {
            return this.readParticle(packetdataserializer, (Particle) packetdataserializer.readById(BuiltInRegistries.PARTICLE_TYPE));
        }
    ...
    public static final DataWatcherSerializer<Sniffer.a> SNIFFER_STATE = DataWatcherSerializer.simpleEnum(Sniffer.a.class);
