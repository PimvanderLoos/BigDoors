...
public class DataConverterCustomNameEntity extends DataFix {
    ...
    public static Dynamic<?> fixTagCustomName(Dynamic<?> dynamic) {
        ...
        return s.isEmpty() ? dynamic.remove("CustomName") : dynamic.set("CustomName", dynamic.createString(IChatBaseComponent.ChatSerializer.toJson(new ChatComponentText(s))));
    }
}
