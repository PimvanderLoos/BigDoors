...
public class DataConverterObjectiveRenderType extends DataFix {
    ...
    private static IScoreboardCriteria.EnumScoreboardHealthDisplay getRenderType(String s) {
        ...
        return this.fixTypeEverywhereTyped("ObjectiveRenderTypeFix", type, (typed) -> {
            return typed.update(DSL.remainderFinder(), (dynamic) -> {
                ...
                if (!optional.isPresent()) {
                    ...
                    IScoreboardCriteria.EnumScoreboardHealthDisplay iscoreboardcriteria_enumscoreboardhealthdisplay = getRenderType(s);

                    return dynamic.set("RenderType", dynamic.createString(iscoreboardcriteria_enumscoreboardhealthdisplay.getId()));
                } else {
                    return dynamic;
                }
            });
