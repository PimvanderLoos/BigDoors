...
public class EntitySkeletonStray extends EntitySkeletonAbstract {
    ...
    public static boolean checkStraySpawnRules(EntityTypes<EntitySkeletonStray> entitytypes, WorldAccess worldaccess, EnumMobSpawn enummobspawn, BlockPosition blockposition, Random random) {
        ...
        return checkMonsterSpawnRules(entitytypes, worldaccess, enummobspawn, blockposition, random) && (enummobspawn == EnumMobSpawn.SPAWNER || worldaccess.canSeeSky(blockposition1.below()));
    }
