...
public class DefinedStructureProcessorPredicates {
    ...
    public boolean test(IBlockData iblockdata, IBlockData iblockdata1, BlockPosition blockposition, BlockPosition blockposition1, BlockPosition blockposition2, Random random) {
        return this.inputPredicate.test(iblockdata, random) && this.locPredicate.test(iblockdata1, random) && this.posPredicate.test(blockposition, blockposition1, blockposition2, random);
    }
