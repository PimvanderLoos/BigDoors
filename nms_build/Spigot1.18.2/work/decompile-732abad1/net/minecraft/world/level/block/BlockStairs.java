...
public class BlockStairs extends Block implements IBlockWaterlogged {
    ...
    public void animateTick(IBlockData iblockdata, World world, BlockPosition blockposition, Random random) {
        this.base.animateTick(iblockdata, world, blockposition, random);
    }
    ...
    public void onPlace(IBlockData iblockdata, World world, BlockPosition blockposition, IBlockData iblockdata1, boolean flag) {
        if (!iblockdata.is(iblockdata.getBlock())) {
            this.baseState.neighborChanged(world, blockposition, Blocks.AIR, blockposition, false);
    ...
    public void randomTick(IBlockData iblockdata, WorldServer worldserver, BlockPosition blockposition, Random random) {
        this.base.randomTick(iblockdata, worldserver, blockposition, random);
    }
