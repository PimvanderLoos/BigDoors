...
public class WorldGenFeatureDelta extends WorldGenerator<WorldGenFeatureDeltaConfiguration> {
    ...
    public boolean place(FeaturePlaceContext<WorldGenFeatureDeltaConfiguration> featureplacecontext) {
        ...
        int i = flag1 ? worldgenfeaturedeltaconfiguration.rimSize().sample(random) : 0;
        int j = flag1 ? worldgenfeaturedeltaconfiguration.rimSize().sample(random) : 0;
        boolean flag2 = flag1 && i != 0 && j != 0;
        int k = worldgenfeaturedeltaconfiguration.size().sample(random);
        int l = worldgenfeaturedeltaconfiguration.size().sample(random);
        int i1 = Math.max(k, l);
