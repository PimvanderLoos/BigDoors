...
public class Noises {
    ...
    private static ResourceKey<NoiseGeneratorNormal.a> createKey(String s) {
        return ResourceKey.create(IRegistry.NOISE_REGISTRY, new MinecraftKey(s));
    }

    public static NoiseGeneratorNormal instantiate(IRegistry<NoiseGeneratorNormal.a> iregistry, PositionalRandomFactory positionalrandomfactory, ResourceKey<NoiseGeneratorNormal.a> resourcekey) {
        Holder<NoiseGeneratorNormal.a> holder = iregistry.getHolderOrThrow(resourcekey);

        return instantiate(positionalrandomfactory, holder);
    }

    public static NoiseGeneratorNormal instantiate(PositionalRandomFactory positionalrandomfactory, Holder<NoiseGeneratorNormal.a> holder) {
