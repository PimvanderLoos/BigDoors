...
public abstract class BiomeRegistry {
    ...
    private static void register(ResourceKey<BiomeBase> resourcekey, BiomeBase biomebase) {
        RegistryGeneration.register(RegistryGeneration.BIOME, resourcekey, biomebase);
    }

    public static Holder<BiomeBase> bootstrap() {
        return RegistryGeneration.BIOME.getHolderOrThrow(Biomes.PLAINS);
    }

    static {
        register(Biomes.THE_VOID, OverworldBiomes.theVoid());
        register(Biomes.PLAINS, OverworldBiomes.plains(false, false, false));
