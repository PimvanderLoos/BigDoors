...
public interface PacketListenerPlayOut extends PacketListener {
    ...
    void handleAddMob(PacketPlayOutSpawnEntityLiving packetplayoutspawnentityliving);

    void handleAddObjective(PacketPlayOutScoreboardObjective packetplayoutscoreboardobjective);

    void handleAddPainting(PacketPlayOutSpawnEntityPainting packetplayoutspawnentitypainting);
    ...
    void handleChat(PacketPlayOutChat packetplayoutchat);
    ...
    void handleBlockBreakAck(PacketPlayOutBlockBreak packetplayoutblockbreak);
