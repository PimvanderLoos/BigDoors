...
public final class BiomeMegaTaigaHills extends BiomeBase {
    ...
    public BiomeMegaTaigaHills() {
        ...
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.at, new WorldGenFeatureFlowingConfiguration(FluidTypes.c), BiomeMegaTaigaHills.u, new WorldGenFeatureChanceDecoratorCountConfiguration(50, 8, 8, 256)));
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.at, new WorldGenFeatureFlowingConfiguration(FluidTypes.e), BiomeMegaTaigaHills.v, new WorldGenFeatureChanceDecoratorCountConfiguration(20, 8, 16, 256)));
