...
public final class BiomeMushrooms extends BiomeBase {
    ...
    public BiomeMushrooms() {
        ...
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.at, new WorldGenFeatureFlowingConfiguration(FluidTypes.c), BiomeMushrooms.u, new WorldGenFeatureChanceDecoratorCountConfiguration(50, 8, 8, 256)));
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.at, new WorldGenFeatureFlowingConfiguration(FluidTypes.e), BiomeMushrooms.v, new WorldGenFeatureChanceDecoratorCountConfiguration(20, 8, 16, 256)));
