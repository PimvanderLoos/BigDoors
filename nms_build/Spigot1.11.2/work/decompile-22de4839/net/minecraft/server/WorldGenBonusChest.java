    ...
    public boolean generate(World world, Random random, BlockPosition blockposition) {
        ...
        if (blockposition.getY() < 1) {
            ...
            for (int i = 0; i < 4; ++i) {
                ...
                if (world.isEmpty(blockposition1) && world.getType(blockposition1.down()).r()) {
                    ...
                    if (world.isEmpty(blockposition3) && world.getType(blockposition3.down()).r()) {
                        world.setTypeAndData(blockposition3, Blocks.TORCH.getBlockData(), 2);
                    }

                    if (world.isEmpty(blockposition2) && world.getType(blockposition2.down()).r()) {
                        world.setTypeAndData(blockposition2, Blocks.TORCH.getBlockData(), 2);
                    }

                    if (world.isEmpty(blockposition4) && world.getType(blockposition4.down()).r()) {
                        world.setTypeAndData(blockposition4, Blocks.TORCH.getBlockData(), 2);
                    }

                    if (world.isEmpty(blockposition5) && world.getType(blockposition5.down()).r()) {
