...
public class ShapelessRecipes implements RecipeCrafting {
    ...
    public ShapelessRecipes(MinecraftKey minecraftkey, String s, CraftingBookCategory craftingbookcategory, ItemStack itemstack, NonNullList<RecipeItemStack> nonnulllist) {
