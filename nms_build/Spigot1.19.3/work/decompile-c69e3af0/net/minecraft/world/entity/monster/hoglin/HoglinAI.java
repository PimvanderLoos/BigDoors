...
public class HoglinAI {
    ...
    protected static void updateActivity(EntityHoglin entityhoglin) {
        ...
        if (activity != activity1) {
            ...
            optional.ifPresent(entityhoglin::playSoundEvent);
        }
