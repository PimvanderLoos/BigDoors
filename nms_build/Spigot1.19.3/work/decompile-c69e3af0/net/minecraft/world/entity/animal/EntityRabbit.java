...
public class EntityRabbit extends EntityAnimal implements VariantHolder<EntityRabbit.Variant> {
    ...
    private static EntityRabbit.Variant getRandomRabbitVariant(GeneratorAccess generatoraccess, BlockPosition blockposition) {
        ...
        return ((BiomeBase) holder.value()).getPrecipitation() == BiomeBase.Precipitation.SNOW ? (i < 80 ? EntityRabbit.Variant.WHITE : EntityRabbit.Variant.WHITE_SPLOTCHED) : (holder.is(BiomeTags.ONLY_ALLOWS_SNOW_AND_GOLD_RABBITS) ? EntityRabbit.Variant.GOLD : (i < 50 ? EntityRabbit.Variant.BROWN : (i < 90 ? EntityRabbit.Variant.SALT : EntityRabbit.Variant.BLACK)));
    }
