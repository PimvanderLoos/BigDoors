...
public abstract class EntityHorseAbstract extends EntityAnimal implements IInventoryListener, HasCustomInventoryScreen, IJumpable, ISaddleable {
    ...
    public void equipSaddle(@Nullable SoundCategory soundcategory) {
        ...
        if (soundcategory != null) {
            this.level.playSound((EntityHuman) null, (Entity) this, this.getSaddleSoundEvent(), soundcategory, 0.5F, 1.0F);
        }
    ...
    protected void executeRidersJump(float f, float f1, float f2) {
        ...
        if (f2 > 0.0F) {
            ...
            this.setDeltaMovement(this.getDeltaMovement().add((double) (-0.4F * f3 * f), 0.0D, (double) (0.4F * f4 * f)));
        }
