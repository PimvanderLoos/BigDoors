    ...
    public MinecraftKey getDefaultLootTable() {
        if (this.isSheared()) {
            ...
            switch (this.getColor()) {
                case WHITE:
                    minecraftkey = LootTables.SHEEP_WHITE;
                    break;
                case ORANGE:
                    minecraftkey = LootTables.SHEEP_ORANGE;
                    break;
                case MAGENTA:
                    minecraftkey = LootTables.SHEEP_MAGENTA;
                    break;
                case LIGHT_BLUE:
                    minecraftkey = LootTables.SHEEP_LIGHT_BLUE;
                    break;
                case YELLOW:
                    minecraftkey = LootTables.SHEEP_YELLOW;
                    break;
                case LIME:
                    minecraftkey = LootTables.SHEEP_LIME;
                    break;
                case PINK:
                    minecraftkey = LootTables.SHEEP_PINK;
                    break;
                case GRAY:
                    minecraftkey = LootTables.SHEEP_GRAY;
                    break;
                case LIGHT_GRAY:
                    minecraftkey = LootTables.SHEEP_LIGHT_GRAY;
                    break;
                case CYAN:
                    minecraftkey = LootTables.SHEEP_CYAN;
                    break;
                case PURPLE:
                    minecraftkey = LootTables.SHEEP_PURPLE;
                    break;
                case BLUE:
                    minecraftkey = LootTables.SHEEP_BLUE;
                    break;
                case BROWN:
                    minecraftkey = LootTables.SHEEP_BROWN;
                    break;
                case GREEN:
                    minecraftkey = LootTables.SHEEP_GREEN;
                    break;
                case RED:
                    minecraftkey = LootTables.SHEEP_RED;
                    break;
                case BLACK:
                    minecraftkey = LootTables.SHEEP_BLACK;
                    break;
                default:
