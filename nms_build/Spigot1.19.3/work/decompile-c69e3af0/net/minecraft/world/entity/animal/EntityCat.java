...
public class EntityCat extends EntityTameableAnimal implements VariantHolder<CatVariant> {
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(EntityCat.DATA_VARIANT_ID, (CatVariant) BuiltInRegistries.CAT_VARIANT.getOrThrow(CatVariant.BLACK));
    ...
    public void addAdditionalSaveData(NBTTagCompound nbttagcompound) {
        ...
        nbttagcompound.putString("variant", BuiltInRegistries.CAT_VARIANT.getKey(this.getVariant()).toString());
    ...
    public void readAdditionalSaveData(NBTTagCompound nbttagcompound) {
        ...
        CatVariant catvariant = (CatVariant) BuiltInRegistries.CAT_VARIANT.get(MinecraftKey.tryParse(nbttagcompound.getString("variant")));
    ...
    public EntityCat getBreedOffspring(WorldServer worldserver, EntityAgeable entityageable) {
        ...
        if (entitycat != null && entityageable instanceof EntityCat) {
            EntityCat entitycat1 = (EntityCat) entityageable;
