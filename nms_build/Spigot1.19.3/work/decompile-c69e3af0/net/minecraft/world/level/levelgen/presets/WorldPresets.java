...
public class WorldPresets {
    ...
    public static void bootstrap(BootstapContext<WorldPreset> bootstapcontext) {
        (new WorldPresets.a(bootstapcontext)).run();
    }
    ...
    private static class a {
        ...
        a(BootstapContext<WorldPreset> bootstapcontext) {
            ...
            this.netherStem = new WorldDimension(holder, new ChunkGeneratorAbstract(WorldChunkManagerMultiNoise.a.NETHER.biomeSource(this.biomes), holder1));
        ...
        public void run() {
            ...
            Holder.c<BiomeBase> holder_c = this.biomes.getOrThrow(Biomes.PLAINS);

            this.registerCustomOverworldPreset(WorldPresets.SINGLE_BIOME_SURFACE, this.makeNoiseBasedOverworld(new WorldChunkManagerHell(holder_c), holder));
            ...
            this.registerCustomOverworldPreset(WorldPresets.DEBUG, this.makeOverworld(new ChunkProviderDebug(holder_c)));
        }
    }
}
