...
public class DefinedStructureProcessorBlockAge extends DefinedStructureProcessor {
    ...
    private static IBlockData getRandomFacingStairs(RandomSource randomsource, Block block) {
        return (IBlockData) ((IBlockData) block.defaultBlockState().setValue(BlockStairs.FACING, EnumDirection.EnumDirectionLimit.HORIZONTAL.getRandomDirection(randomsource))).setValue(BlockStairs.HALF, (BlockPropertyHalf) SystemUtils.getRandom((Object[]) BlockPropertyHalf.values(), randomsource));
    }
