...
public class BlockPropertyWood {
    ...
    public static final BlockPropertyWood MANGROVE = register(new BlockPropertyWood("mangrove"));
    public static final BlockPropertyWood BAMBOO = register(new BlockPropertyWood("bamboo"));
