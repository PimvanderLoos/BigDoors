...
public class LootTableInfo {
    ...
    LootTableInfo(RandomSource randomsource, float f, WorldServer worldserver, Function<MinecraftKey, LootTable> function, Function<MinecraftKey, LootItemCondition> function1, Map<LootContextParameter<?>, Object> map, Map<MinecraftKey, LootTableInfo.b> map1) {
    ...
    public static class Builder {
        ...
        public LootTableInfo.Builder withRandom(RandomSource randomsource) {
            this.random = randomsource;
            return this;
        }
        ...
        public LootTableInfo.Builder withOptionalRandomSeed(long i, RandomSource randomsource) {
            if (i == 0L) {
                this.random = randomsource;
            } else {
                this.random = RandomSource.create(i);
        ...
        public LootTableInfo create(LootContextParameterSet lootcontextparameterset) {
            ...
            if (!set.isEmpty()) {
                ...
                if (!set1.isEmpty()) {
                    ...
                    return new LootTableInfo(randomsource, f, worldserver, function, lootpredicatemanager::get, this.params, this.dynamicDrops);
                }
            }
        }
    }
