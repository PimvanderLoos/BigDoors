...
public class Blocks {
    ...
    public static final Block BAMBOO_SIGN = register("bamboo_sign", new BlockFloorSign(BlockBase.Info.of(Material.WOOD, Blocks.BAMBOO_PLANKS.defaultMaterialColor()).noCollission().strength(1.0F).sound(SoundEffectType.BAMBOO_WOOD).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.BAMBOO));
    public static final Block OAK_DOOR = register("oak_door", new BlockDoor(BlockBase.Info.of(Material.WOOD, Blocks.OAK_PLANKS.defaultMaterialColor()).strength(3.0F).sound(SoundEffectType.WOOD).noOcclusion(), SoundEffects.WOODEN_DOOR_CLOSE, SoundEffects.WOODEN_DOOR_OPEN));
    ...
    public static final Block BAMBOO_WALL_SIGN = register("bamboo_wall_sign", new BlockWallSign(BlockBase.Info.of(Material.WOOD, Blocks.BAMBOO_PLANKS.defaultMaterialColor()).noCollission().strength(1.0F).sound(SoundEffectType.BAMBOO_WOOD).requiredFeatures(FeatureFlags.UPDATE_1_20).dropsLike(Blocks.BAMBOO_SIGN), BlockPropertyWood.BAMBOO));
    public static final Block OAK_HANGING_SIGN = register("oak_hanging_sign", new CeilingHangingSignBlock(BlockBase.Info.of(Material.WOOD, Blocks.OAK_LOG.defaultMaterialColor()).noCollission().strength(1.0F).sound(SoundEffectType.HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.OAK));
    public static final Block SPRUCE_HANGING_SIGN = register("spruce_hanging_sign", new CeilingHangingSignBlock(BlockBase.Info.of(Material.WOOD, Blocks.SPRUCE_LOG.defaultMaterialColor()).noCollission().strength(1.0F).sound(SoundEffectType.HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.SPRUCE));
    public static final Block BIRCH_HANGING_SIGN = register("birch_hanging_sign", new CeilingHangingSignBlock(BlockBase.Info.of(Material.WOOD, MaterialMapColor.SAND).noCollission().strength(1.0F).sound(SoundEffectType.HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.BIRCH));
    public static final Block ACACIA_HANGING_SIGN = register("acacia_hanging_sign", new CeilingHangingSignBlock(BlockBase.Info.of(Material.WOOD, MaterialMapColor.COLOR_ORANGE).noCollission().strength(1.0F).sound(SoundEffectType.HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.ACACIA));
    public static final Block JUNGLE_HANGING_SIGN = register("jungle_hanging_sign", new CeilingHangingSignBlock(BlockBase.Info.of(Material.WOOD, Blocks.JUNGLE_LOG.defaultMaterialColor()).noCollission().strength(1.0F).sound(SoundEffectType.HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.JUNGLE));
    public static final Block DARK_OAK_HANGING_SIGN = register("dark_oak_hanging_sign", new CeilingHangingSignBlock(BlockBase.Info.of(Material.WOOD, Blocks.DARK_OAK_LOG.defaultMaterialColor()).noCollission().strength(1.0F).sound(SoundEffectType.HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.DARK_OAK));
    public static final Block CRIMSON_HANGING_SIGN = register("crimson_hanging_sign", new CeilingHangingSignBlock(BlockBase.Info.of(Material.WOOD, MaterialMapColor.CRIMSON_STEM).noCollission().strength(1.0F).sound(SoundEffectType.NETHER_WOOD_HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.CRIMSON));
    public static final Block WARPED_HANGING_SIGN = register("warped_hanging_sign", new CeilingHangingSignBlock(BlockBase.Info.of(Material.WOOD, MaterialMapColor.WARPED_STEM).noCollission().strength(1.0F).sound(SoundEffectType.NETHER_WOOD_HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.WARPED));
    public static final Block MANGROVE_HANGING_SIGN = register("mangrove_hanging_sign", new CeilingHangingSignBlock(BlockBase.Info.of(Material.WOOD, Blocks.MANGROVE_LOG.defaultMaterialColor()).noCollission().strength(1.0F).sound(SoundEffectType.HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.MANGROVE));
    public static final Block BAMBOO_HANGING_SIGN = register("bamboo_hanging_sign", new CeilingHangingSignBlock(BlockBase.Info.of(Material.WOOD, MaterialMapColor.COLOR_YELLOW).noCollission().strength(1.0F).sound(SoundEffectType.BAMBOO_WOOD_HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.BAMBOO));
    public static final Block OAK_WALL_HANGING_SIGN = register("oak_wall_hanging_sign", new WallHangingSignBlock(BlockBase.Info.of(Material.WOOD, Blocks.OAK_LOG.defaultMaterialColor()).noCollission().strength(1.0F).sound(SoundEffectType.HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20).dropsLike(Blocks.OAK_HANGING_SIGN), BlockPropertyWood.OAK));
    public static final Block SPRUCE_WALL_HANGING_SIGN = register("spruce_wall_hanging_sign", new WallHangingSignBlock(BlockBase.Info.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundEffectType.HANGING_SIGN).dropsLike(Blocks.SPRUCE_HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.SPRUCE));
    public static final Block BIRCH_WALL_HANGING_SIGN = register("birch_wall_hanging_sign", new WallHangingSignBlock(BlockBase.Info.of(Material.SAND).noCollission().strength(1.0F).sound(SoundEffectType.HANGING_SIGN).dropsLike(Blocks.BIRCH_HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.BIRCH));
    public static final Block ACACIA_WALL_HANGING_SIGN = register("acacia_wall_hanging_sign", new WallHangingSignBlock(BlockBase.Info.of(Material.WOOD, MaterialMapColor.COLOR_ORANGE).noCollission().strength(1.0F).sound(SoundEffectType.HANGING_SIGN).dropsLike(Blocks.ACACIA_HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.ACACIA));
    public static final Block JUNGLE_WALL_HANGING_SIGN = register("jungle_wall_hanging_sign", new WallHangingSignBlock(BlockBase.Info.of(Material.WOOD, Blocks.JUNGLE_LOG.defaultMaterialColor()).noCollission().strength(1.0F).sound(SoundEffectType.HANGING_SIGN).dropsLike(Blocks.JUNGLE_HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.JUNGLE));
    public static final Block DARK_OAK_WALL_HANGING_SIGN = register("dark_oak_wall_hanging_sign", new WallHangingSignBlock(BlockBase.Info.of(Material.WOOD, Blocks.DARK_OAK_LOG.defaultMaterialColor()).noCollission().strength(1.0F).sound(SoundEffectType.HANGING_SIGN).dropsLike(Blocks.DARK_OAK_HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.DARK_OAK));
    public static final Block MANGROVE_WALL_HANGING_SIGN = register("mangrove_wall_hanging_sign", new WallHangingSignBlock(BlockBase.Info.of(Material.WOOD, Blocks.MANGROVE_LOG.defaultMaterialColor()).noCollission().strength(1.0F).sound(SoundEffectType.HANGING_SIGN).dropsLike(Blocks.MANGROVE_HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.MANGROVE));
    public static final Block CRIMSON_WALL_HANGING_SIGN = register("crimson_wall_hanging_sign", new WallHangingSignBlock(BlockBase.Info.of(Material.WOOD, MaterialMapColor.CRIMSON_STEM).noCollission().strength(1.0F).sound(SoundEffectType.NETHER_WOOD_HANGING_SIGN).dropsLike(Blocks.CRIMSON_HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.CRIMSON));
    public static final Block WARPED_WALL_HANGING_SIGN = register("warped_wall_hanging_sign", new WallHangingSignBlock(BlockBase.Info.of(Material.WOOD, MaterialMapColor.WARPED_STEM).noCollission().strength(1.0F).sound(SoundEffectType.NETHER_WOOD_HANGING_SIGN).dropsLike(Blocks.WARPED_HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.WARPED));
    public static final Block BAMBOO_WALL_HANGING_SIGN = register("bamboo_wall_hanging_sign", new WallHangingSignBlock(BlockBase.Info.of(Material.WOOD, MaterialMapColor.COLOR_YELLOW).noCollission().strength(1.0F).sound(SoundEffectType.BAMBOO_WOOD_HANGING_SIGN).dropsLike(Blocks.BAMBOO_HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), BlockPropertyWood.BAMBOO));
    ...
    public static final Block STONE_PRESSURE_PLATE = register("stone_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.MOBS, BlockBase.Info.of(Material.STONE).requiresCorrectToolForDrops().noCollission().strength(0.5F), SoundEffects.STONE_PRESSURE_PLATE_CLICK_OFF, SoundEffects.STONE_PRESSURE_PLATE_CLICK_ON));
    public static final Block IRON_DOOR = register("iron_door", new BlockDoor(BlockBase.Info.of(Material.METAL, MaterialMapColor.METAL).requiresCorrectToolForDrops().strength(5.0F).sound(SoundEffectType.METAL).noOcclusion(), SoundEffects.IRON_DOOR_CLOSE, SoundEffects.IRON_DOOR_OPEN));
    public static final Block OAK_PRESSURE_PLATE = register("oak_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of(Material.WOOD, Blocks.OAK_PLANKS.defaultMaterialColor()).noCollission().strength(0.5F).sound(SoundEffectType.WOOD), SoundEffects.WOODEN_PRESSURE_PLATE_CLICK_OFF, SoundEffects.WOODEN_PRESSURE_PLATE_CLICK_ON));
    public static final Block SPRUCE_PRESSURE_PLATE = register("spruce_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of(Material.WOOD, Blocks.SPRUCE_PLANKS.defaultMaterialColor()).noCollission().strength(0.5F).sound(SoundEffectType.WOOD), SoundEffects.WOODEN_PRESSURE_PLATE_CLICK_OFF, SoundEffects.WOODEN_PRESSURE_PLATE_CLICK_ON));
    public static final Block BIRCH_PRESSURE_PLATE = register("birch_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of(Material.WOOD, Blocks.BIRCH_PLANKS.defaultMaterialColor()).noCollission().strength(0.5F).sound(SoundEffectType.WOOD), SoundEffects.WOODEN_PRESSURE_PLATE_CLICK_OFF, SoundEffects.WOODEN_PRESSURE_PLATE_CLICK_ON));
    public static final Block JUNGLE_PRESSURE_PLATE = register("jungle_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of(Material.WOOD, Blocks.JUNGLE_PLANKS.defaultMaterialColor()).noCollission().strength(0.5F).sound(SoundEffectType.WOOD), SoundEffects.WOODEN_PRESSURE_PLATE_CLICK_OFF, SoundEffects.WOODEN_PRESSURE_PLATE_CLICK_ON));
    public static final Block ACACIA_PRESSURE_PLATE = register("acacia_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of(Material.WOOD, Blocks.ACACIA_PLANKS.defaultMaterialColor()).noCollission().strength(0.5F).sound(SoundEffectType.WOOD), SoundEffects.WOODEN_PRESSURE_PLATE_CLICK_OFF, SoundEffects.WOODEN_PRESSURE_PLATE_CLICK_ON));
    public static final Block DARK_OAK_PRESSURE_PLATE = register("dark_oak_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of(Material.WOOD, Blocks.DARK_OAK_PLANKS.defaultMaterialColor()).noCollission().strength(0.5F).sound(SoundEffectType.WOOD), SoundEffects.WOODEN_PRESSURE_PLATE_CLICK_OFF, SoundEffects.WOODEN_PRESSURE_PLATE_CLICK_ON));
    public static final Block MANGROVE_PRESSURE_PLATE = register("mangrove_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of(Material.WOOD, Blocks.MANGROVE_PLANKS.defaultMaterialColor()).noCollission().strength(0.5F).sound(SoundEffectType.WOOD), SoundEffects.WOODEN_PRESSURE_PLATE_CLICK_OFF, SoundEffects.WOODEN_PRESSURE_PLATE_CLICK_ON));
    public static final Block BAMBOO_PRESSURE_PLATE = register("bamboo_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of(Material.WOOD, Blocks.BAMBOO_PLANKS.defaultMaterialColor()).noCollission().strength(0.5F).sound(SoundEffectType.BAMBOO_WOOD).requiredFeatures(FeatureFlags.UPDATE_1_20), SoundEffects.BAMBOO_WOOD_PRESSURE_PLATE_CLICK_OFF, SoundEffects.BAMBOO_WOOD_PRESSURE_PLATE_CLICK_ON));
    ...
    public static final Block OAK_TRAPDOOR = register("oak_trapdoor", new BlockTrapdoor(BlockBase.Info.of(Material.WOOD, MaterialMapColor.WOOD).strength(3.0F).sound(SoundEffectType.WOOD).noOcclusion().isValidSpawn(Blocks::never), SoundEffects.WOODEN_TRAPDOOR_CLOSE, SoundEffects.WOODEN_TRAPDOOR_OPEN));
    public static final Block SPRUCE_TRAPDOOR = register("spruce_trapdoor", new BlockTrapdoor(BlockBase.Info.of(Material.WOOD, MaterialMapColor.PODZOL).strength(3.0F).sound(SoundEffectType.WOOD).noOcclusion().isValidSpawn(Blocks::never), SoundEffects.WOODEN_TRAPDOOR_CLOSE, SoundEffects.WOODEN_TRAPDOOR_OPEN));
    public static final Block BIRCH_TRAPDOOR = register("birch_trapdoor", new BlockTrapdoor(BlockBase.Info.of(Material.WOOD, MaterialMapColor.SAND).strength(3.0F).sound(SoundEffectType.WOOD).noOcclusion().isValidSpawn(Blocks::never), SoundEffects.WOODEN_TRAPDOOR_CLOSE, SoundEffects.WOODEN_TRAPDOOR_OPEN));
    public static final Block JUNGLE_TRAPDOOR = register("jungle_trapdoor", new BlockTrapdoor(BlockBase.Info.of(Material.WOOD, MaterialMapColor.DIRT).strength(3.0F).sound(SoundEffectType.WOOD).noOcclusion().isValidSpawn(Blocks::never), SoundEffects.WOODEN_TRAPDOOR_CLOSE, SoundEffects.WOODEN_TRAPDOOR_OPEN));
    public static final Block ACACIA_TRAPDOOR = register("acacia_trapdoor", new BlockTrapdoor(BlockBase.Info.of(Material.WOOD, MaterialMapColor.COLOR_ORANGE).strength(3.0F).sound(SoundEffectType.WOOD).noOcclusion().isValidSpawn(Blocks::never), SoundEffects.WOODEN_TRAPDOOR_CLOSE, SoundEffects.WOODEN_TRAPDOOR_OPEN));
    public static final Block DARK_OAK_TRAPDOOR = register("dark_oak_trapdoor", new BlockTrapdoor(BlockBase.Info.of(Material.WOOD, MaterialMapColor.COLOR_BROWN).strength(3.0F).sound(SoundEffectType.WOOD).noOcclusion().isValidSpawn(Blocks::never), SoundEffects.WOODEN_TRAPDOOR_CLOSE, SoundEffects.WOODEN_TRAPDOOR_OPEN));
    public static final Block MANGROVE_TRAPDOOR = register("mangrove_trapdoor", new BlockTrapdoor(BlockBase.Info.of(Material.WOOD, MaterialMapColor.COLOR_RED).strength(3.0F).sound(SoundEffectType.WOOD).noOcclusion().isValidSpawn(Blocks::never), SoundEffects.WOODEN_TRAPDOOR_CLOSE, SoundEffects.WOODEN_TRAPDOOR_OPEN));
    public static final Block BAMBOO_TRAPDOOR = register("bamboo_trapdoor", new BlockTrapdoor(BlockBase.Info.of(Material.WOOD, MaterialMapColor.COLOR_YELLOW).strength(3.0F).sound(SoundEffectType.BAMBOO_WOOD).noOcclusion().isValidSpawn(Blocks::never).requiredFeatures(FeatureFlags.UPDATE_1_20), SoundEffects.BAMBOO_WOOD_TRAPDOOR_CLOSE, SoundEffects.BAMBOO_WOOD_TRAPDOOR_OPEN));
    ...
    public static final Block OAK_FENCE_GATE = register("oak_fence_gate", new BlockFenceGate(BlockBase.Info.of(Material.WOOD, Blocks.OAK_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.WOOD), SoundEffects.FENCE_GATE_CLOSE, SoundEffects.FENCE_GATE_OPEN));
    ...
    public static final Block BAMBOO_BUTTON = register("bamboo_button", new BlockButtonAbstract(BlockBase.Info.of(Material.DECORATION).noCollission().strength(0.5F).sound(SoundEffectType.BAMBOO_WOOD).requiredFeatures(FeatureFlags.UPDATE_1_20), 30, true, SoundEffects.BAMBOO_WOOD_BUTTON_CLICK_OFF, SoundEffects.BAMBOO_WOOD_BUTTON_CLICK_ON));
    ...
    public static final Block LIGHT_WEIGHTED_PRESSURE_PLATE = register("light_weighted_pressure_plate", new BlockPressurePlateWeighted(15, BlockBase.Info.of(Material.METAL, MaterialMapColor.GOLD).requiresCorrectToolForDrops().noCollission().strength(0.5F).sound(SoundEffectType.METAL), SoundEffects.METAL_PRESSURE_PLATE_CLICK_OFF, SoundEffects.METAL_PRESSURE_PLATE_CLICK_ON));
    public static final Block HEAVY_WEIGHTED_PRESSURE_PLATE = register("heavy_weighted_pressure_plate", new BlockPressurePlateWeighted(150, BlockBase.Info.of(Material.METAL).requiresCorrectToolForDrops().noCollission().strength(0.5F).sound(SoundEffectType.METAL), SoundEffects.METAL_PRESSURE_PLATE_CLICK_OFF, SoundEffects.METAL_PRESSURE_PLATE_CLICK_ON));
    ...
    public static final Block IRON_TRAPDOOR = register("iron_trapdoor", new BlockTrapdoor(BlockBase.Info.of(Material.METAL).requiresCorrectToolForDrops().strength(5.0F).sound(SoundEffectType.METAL).noOcclusion().isValidSpawn(Blocks::never), SoundEffects.IRON_TRAPDOOR_CLOSE, SoundEffects.IRON_TRAPDOOR_OPEN));
    ...
    public static final Block SPRUCE_FENCE_GATE = register("spruce_fence_gate", new BlockFenceGate(BlockBase.Info.of(Material.WOOD, Blocks.SPRUCE_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.WOOD), SoundEffects.FENCE_GATE_CLOSE, SoundEffects.FENCE_GATE_OPEN));
    public static final Block BIRCH_FENCE_GATE = register("birch_fence_gate", new BlockFenceGate(BlockBase.Info.of(Material.WOOD, Blocks.BIRCH_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.WOOD), SoundEffects.FENCE_GATE_CLOSE, SoundEffects.FENCE_GATE_OPEN));
    public static final Block JUNGLE_FENCE_GATE = register("jungle_fence_gate", new BlockFenceGate(BlockBase.Info.of(Material.WOOD, Blocks.JUNGLE_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.WOOD), SoundEffects.FENCE_GATE_CLOSE, SoundEffects.FENCE_GATE_OPEN));
    public static final Block ACACIA_FENCE_GATE = register("acacia_fence_gate", new BlockFenceGate(BlockBase.Info.of(Material.WOOD, Blocks.ACACIA_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.WOOD), SoundEffects.FENCE_GATE_CLOSE, SoundEffects.FENCE_GATE_OPEN));
    public static final Block DARK_OAK_FENCE_GATE = register("dark_oak_fence_gate", new BlockFenceGate(BlockBase.Info.of(Material.WOOD, Blocks.DARK_OAK_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.WOOD), SoundEffects.FENCE_GATE_CLOSE, SoundEffects.FENCE_GATE_OPEN));
    public static final Block MANGROVE_FENCE_GATE = register("mangrove_fence_gate", new BlockFenceGate(BlockBase.Info.of(Material.WOOD, Blocks.MANGROVE_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.WOOD), SoundEffects.FENCE_GATE_CLOSE, SoundEffects.FENCE_GATE_OPEN));
    public static final Block BAMBOO_FENCE_GATE = register("bamboo_fence_gate", new BlockFenceGate(BlockBase.Info.of(Material.WOOD, Blocks.BAMBOO_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.BAMBOO_WOOD).requiredFeatures(FeatureFlags.UPDATE_1_20), SoundEffects.BAMBOO_WOOD_FENCE_GATE_CLOSE, SoundEffects.BAMBOO_WOOD_FENCE_GATE_OPEN));
    ...
    public static final Block SPRUCE_DOOR = register("spruce_door", new BlockDoor(BlockBase.Info.of(Material.WOOD, Blocks.SPRUCE_PLANKS.defaultMaterialColor()).strength(3.0F).sound(SoundEffectType.WOOD).noOcclusion(), SoundEffects.WOODEN_DOOR_CLOSE, SoundEffects.WOODEN_DOOR_OPEN));
    public static final Block BIRCH_DOOR = register("birch_door", new BlockDoor(BlockBase.Info.of(Material.WOOD, Blocks.BIRCH_PLANKS.defaultMaterialColor()).strength(3.0F).sound(SoundEffectType.WOOD).noOcclusion(), SoundEffects.WOODEN_DOOR_CLOSE, SoundEffects.WOODEN_DOOR_OPEN));
    public static final Block JUNGLE_DOOR = register("jungle_door", new BlockDoor(BlockBase.Info.of(Material.WOOD, Blocks.JUNGLE_PLANKS.defaultMaterialColor()).strength(3.0F).sound(SoundEffectType.WOOD).noOcclusion(), SoundEffects.WOODEN_DOOR_CLOSE, SoundEffects.WOODEN_DOOR_OPEN));
    public static final Block ACACIA_DOOR = register("acacia_door", new BlockDoor(BlockBase.Info.of(Material.WOOD, Blocks.ACACIA_PLANKS.defaultMaterialColor()).strength(3.0F).sound(SoundEffectType.WOOD).noOcclusion(), SoundEffects.WOODEN_DOOR_CLOSE, SoundEffects.WOODEN_DOOR_OPEN));
    public static final Block DARK_OAK_DOOR = register("dark_oak_door", new BlockDoor(BlockBase.Info.of(Material.WOOD, Blocks.DARK_OAK_PLANKS.defaultMaterialColor()).strength(3.0F).sound(SoundEffectType.WOOD).noOcclusion(), SoundEffects.WOODEN_DOOR_CLOSE, SoundEffects.WOODEN_DOOR_OPEN));
    public static final Block MANGROVE_DOOR = register("mangrove_door", new BlockDoor(BlockBase.Info.of(Material.WOOD, Blocks.MANGROVE_PLANKS.defaultMaterialColor()).strength(3.0F).sound(SoundEffectType.WOOD).noOcclusion(), SoundEffects.WOODEN_DOOR_CLOSE, SoundEffects.WOODEN_DOOR_OPEN));
    public static final Block BAMBOO_DOOR = register("bamboo_door", new BlockDoor(BlockBase.Info.of(Material.WOOD, Blocks.BAMBOO_PLANKS.defaultMaterialColor()).strength(3.0F).sound(SoundEffectType.BAMBOO_WOOD).noOcclusion().requiredFeatures(FeatureFlags.UPDATE_1_20), SoundEffects.BAMBOO_WOOD_DOOR_CLOSE, SoundEffects.BAMBOO_WOOD_DOOR_OPEN));
    ...
    public static final Block CRIMSON_PRESSURE_PLATE = register("crimson_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of(Material.NETHER_WOOD, Blocks.CRIMSON_PLANKS.defaultMaterialColor()).noCollission().strength(0.5F).sound(SoundEffectType.NETHER_WOOD), SoundEffects.NETHER_WOOD_PRESSURE_PLATE_CLICK_OFF, SoundEffects.NETHER_WOOD_PRESSURE_PLATE_CLICK_ON));
    public static final Block WARPED_PRESSURE_PLATE = register("warped_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of(Material.NETHER_WOOD, Blocks.WARPED_PLANKS.defaultMaterialColor()).noCollission().strength(0.5F).sound(SoundEffectType.NETHER_WOOD), SoundEffects.NETHER_WOOD_PRESSURE_PLATE_CLICK_OFF, SoundEffects.NETHER_WOOD_PRESSURE_PLATE_CLICK_ON));
    ...
    public static final Block CRIMSON_TRAPDOOR = register("crimson_trapdoor", new BlockTrapdoor(BlockBase.Info.of(Material.NETHER_WOOD, Blocks.CRIMSON_PLANKS.defaultMaterialColor()).strength(3.0F).sound(SoundEffectType.NETHER_WOOD).noOcclusion().isValidSpawn(Blocks::never), SoundEffects.NETHER_WOOD_TRAPDOOR_CLOSE, SoundEffects.NETHER_WOOD_TRAPDOOR_OPEN));
    public static final Block WARPED_TRAPDOOR = register("warped_trapdoor", new BlockTrapdoor(BlockBase.Info.of(Material.NETHER_WOOD, Blocks.WARPED_PLANKS.defaultMaterialColor()).strength(3.0F).sound(SoundEffectType.NETHER_WOOD).noOcclusion().isValidSpawn(Blocks::never), SoundEffects.NETHER_WOOD_TRAPDOOR_CLOSE, SoundEffects.NETHER_WOOD_TRAPDOOR_OPEN));
    public static final Block CRIMSON_FENCE_GATE = register("crimson_fence_gate", new BlockFenceGate(BlockBase.Info.of(Material.NETHER_WOOD, Blocks.CRIMSON_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.NETHER_WOOD), SoundEffects.NETHER_WOOD_FENCE_GATE_CLOSE, SoundEffects.NETHER_WOOD_FENCE_GATE_OPEN));
    public static final Block WARPED_FENCE_GATE = register("warped_fence_gate", new BlockFenceGate(BlockBase.Info.of(Material.NETHER_WOOD, Blocks.WARPED_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.NETHER_WOOD), SoundEffects.NETHER_WOOD_FENCE_GATE_CLOSE, SoundEffects.NETHER_WOOD_FENCE_GATE_OPEN));
    ...
    public static final Block CRIMSON_BUTTON = register("crimson_button", woodenButton(SoundEffectType.NETHER_WOOD, SoundEffects.NETHER_WOOD_BUTTON_CLICK_OFF, SoundEffects.NETHER_WOOD_BUTTON_CLICK_ON));
    public static final Block WARPED_BUTTON = register("warped_button", woodenButton(SoundEffectType.NETHER_WOOD, SoundEffects.NETHER_WOOD_BUTTON_CLICK_OFF, SoundEffects.NETHER_WOOD_BUTTON_CLICK_ON));
    public static final Block CRIMSON_DOOR = register("crimson_door", new BlockDoor(BlockBase.Info.of(Material.NETHER_WOOD, Blocks.CRIMSON_PLANKS.defaultMaterialColor()).strength(3.0F).sound(SoundEffectType.NETHER_WOOD).noOcclusion(), SoundEffects.NETHER_WOOD_DOOR_CLOSE, SoundEffects.NETHER_WOOD_DOOR_OPEN));
    public static final Block WARPED_DOOR = register("warped_door", new BlockDoor(BlockBase.Info.of(Material.NETHER_WOOD, Blocks.WARPED_PLANKS.defaultMaterialColor()).strength(3.0F).sound(SoundEffectType.NETHER_WOOD).noOcclusion(), SoundEffects.NETHER_WOOD_DOOR_CLOSE, SoundEffects.NETHER_WOOD_DOOR_OPEN));
    public static final Block CRIMSON_SIGN = register("crimson_sign", new BlockFloorSign(BlockBase.Info.of(Material.NETHER_WOOD, Blocks.CRIMSON_PLANKS.defaultMaterialColor()).noCollission().strength(1.0F).sound(SoundEffectType.NETHER_WOOD), BlockPropertyWood.CRIMSON));
    public static final Block WARPED_SIGN = register("warped_sign", new BlockFloorSign(BlockBase.Info.of(Material.NETHER_WOOD, Blocks.WARPED_PLANKS.defaultMaterialColor()).noCollission().strength(1.0F).sound(SoundEffectType.NETHER_WOOD), BlockPropertyWood.WARPED));
    public static final Block CRIMSON_WALL_SIGN = register("crimson_wall_sign", new BlockWallSign(BlockBase.Info.of(Material.NETHER_WOOD, Blocks.CRIMSON_PLANKS.defaultMaterialColor()).noCollission().strength(1.0F).sound(SoundEffectType.NETHER_WOOD).dropsLike(Blocks.CRIMSON_SIGN), BlockPropertyWood.CRIMSON));
    public static final Block WARPED_WALL_SIGN = register("warped_wall_sign", new BlockWallSign(BlockBase.Info.of(Material.NETHER_WOOD, Blocks.WARPED_PLANKS.defaultMaterialColor()).noCollission().strength(1.0F).sound(SoundEffectType.NETHER_WOOD).dropsLike(Blocks.WARPED_SIGN), BlockPropertyWood.WARPED));
    ...
    private static BlockButtonAbstract woodenButton() {
        return woodenButton(SoundEffectType.WOOD, SoundEffects.WOODEN_BUTTON_CLICK_OFF, SoundEffects.WOODEN_BUTTON_CLICK_ON);
    }

    private static BlockButtonAbstract woodenButton(SoundEffectType soundeffecttype, SoundEffect soundeffect, SoundEffect soundeffect1) {
        return new BlockButtonAbstract(BlockBase.Info.of(Material.DECORATION).noCollission().strength(0.5F).sound(soundeffecttype), 30, true, soundeffect, soundeffect1);
    }

    private static BlockButtonAbstract stoneButton() {
        return new BlockButtonAbstract(BlockBase.Info.of(Material.DECORATION).noCollission().strength(0.5F).sound(SoundEffectType.STONE), 20, false, SoundEffects.STONE_BUTTON_CLICK_OFF, SoundEffects.STONE_BUTTON_CLICK_ON);
    }
