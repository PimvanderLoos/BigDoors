...
public class WorldMap extends PersistentBase {
    ...
    public WorldMap scaled(int i) {
        return createFresh((double) this.centerX, (double) this.centerZ, (byte) MathHelper.clamp(this.scale + i, (int) 0, (int) 4), this.trackingPosition, this.unlimitedTracking, this.dimension);
    }
