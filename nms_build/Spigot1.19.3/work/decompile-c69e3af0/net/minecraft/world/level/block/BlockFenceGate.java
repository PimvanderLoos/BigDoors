...
public class BlockFenceGate extends BlockFacingHorizontal {
    ...
    public BlockFenceGate(BlockBase.Info blockbase_info, SoundEffect soundeffect, SoundEffect soundeffect1) {
    ...
    public EnumInteractionResult use(IBlockData iblockdata, World world, BlockPosition blockposition, EntityHuman entityhuman, EnumHand enumhand, MovingObjectPositionBlock movingobjectpositionblock) {
        ...
        world.playSound(entityhuman, blockposition, flag ? this.openSound : this.closeSound, SoundCategory.BLOCKS, 1.0F, world.getRandom().nextFloat() * 0.1F + 0.9F);
        ...
        if (!world.isClientSide) {
            ...
            if ((Boolean) iblockdata.getValue(BlockFenceGate.POWERED) != flag1) {
                ...
                if ((Boolean) iblockdata.getValue(BlockFenceGate.OPEN) != flag1) {
                    world.playSound((EntityHuman) null, blockposition, flag1 ? this.openSound : this.closeSound, SoundCategory.BLOCKS, 1.0F, world.getRandom().nextFloat() * 0.1F + 0.9F);
