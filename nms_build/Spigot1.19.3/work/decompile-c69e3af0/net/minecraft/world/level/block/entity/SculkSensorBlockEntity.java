...
public class SculkSensorBlockEntity extends TileEntity implements VibrationListener.a {
    ...
    public boolean shouldListen(WorldServer worldserver, GameEventListener gameeventlistener, BlockPosition blockposition, GameEvent gameevent, @Nullable GameEvent.a gameevent_a) {
        return blockposition.equals(this.getBlockPos()) && (gameevent == GameEvent.BLOCK_DESTROY || gameevent == GameEvent.BLOCK_PLACE) ? false : SculkSensorBlock.canActivate(this.getBlockState());
    }
