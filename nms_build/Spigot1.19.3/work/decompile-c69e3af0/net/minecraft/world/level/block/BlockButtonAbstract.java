...
public class BlockButtonAbstract extends BlockAttachable {
    ...
    protected BlockButtonAbstract(BlockBase.Info blockbase_info, int i, boolean flag, SoundEffect soundeffect, SoundEffect soundeffect1) {
    ...
    protected SoundEffect getSound(boolean flag) {
        return flag ? this.soundOn : this.soundOff;
    }
