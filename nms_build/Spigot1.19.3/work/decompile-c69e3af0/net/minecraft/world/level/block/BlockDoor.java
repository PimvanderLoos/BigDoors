...
public class BlockDoor extends Block {
    ...
    protected BlockDoor(BlockBase.Info blockbase_info, SoundEffect soundeffect, SoundEffect soundeffect1) {
    ...
    private void playSound(@Nullable Entity entity, World world, BlockPosition blockposition, boolean flag) {
        world.playSound(entity, blockposition, flag ? this.openSound : this.closeSound, SoundCategory.BLOCKS, 1.0F, world.getRandom().nextFloat() * 0.1F + 0.9F);
    }
