    ...
    private static final class b {
        ...
        void tryPlacingChildren(WorldGenFeaturePillagerOutpostPoolPiece worldgenfeaturepillageroutpostpoolpiece, MutableObject<VoxelShape> mutableobject, int i, boolean flag, LevelHeightAccessor levelheightaccessor, RandomState randomstate) {
            ...
            while (iterator.hasNext()) {
                ...
                int l = -1;
                ResourceKey<WorldGenFeatureDefinedStructurePoolTemplate> resourcekey = readPoolName(definedstructure_blockinfo);
                                    ...
                                    if (flag && structureboundingbox1.getYSpan() <= 16) {
                                        i1 = list1.stream().mapToInt((definedstructure_blockinfo1) -> {
                                            if (!structureboundingbox1.isInside(definedstructure_blockinfo1.pos.relative(BlockJigsaw.getFrontFacing(definedstructure_blockinfo1.state)))) {
                                                ...
                                                ResourceKey<WorldGenFeatureDefinedStructurePoolTemplate> resourcekey1 = readPoolName(definedstructure_blockinfo1);
        ...
        private static ResourceKey<WorldGenFeatureDefinedStructurePoolTemplate> readPoolName(DefinedStructure.BlockInfo definedstructure_blockinfo) {
            return ResourceKey.create(Registries.TEMPLATE_POOL, new MinecraftKey(definedstructure_blockinfo.nbt.getString("pool")));
        }
    }
