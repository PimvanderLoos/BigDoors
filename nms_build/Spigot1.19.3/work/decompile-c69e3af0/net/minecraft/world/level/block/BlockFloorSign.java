...
public class BlockFloorSign extends BlockSign {
    ...
    public IBlockData getStateForPlacement(BlockActionContext blockactioncontext) {
        ...
        return (IBlockData) ((IBlockData) this.defaultBlockState().setValue(BlockFloorSign.ROTATION, RotationSegment.convertToSegment(blockactioncontext.getRotation()))).setValue(BlockFloorSign.WATERLOGGED, fluid.getType() == FluidTypes.WATER);
    }
