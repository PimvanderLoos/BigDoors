...
public class PacketDataSerializer extends ByteBuf {
    ...
    public <T> T readWithCodec(Codec<T> codec) {
        ...
        return SystemUtils.getOrThrow(codec.parse(DynamicOpsNBT.INSTANCE, nbttagcompound), (s) -> {
    ...
    public <T> void writeWithCodec(Codec<T> codec, T t0) {
        NBTBase nbtbase = (NBTBase) SystemUtils.getOrThrow(codec.encodeStart(DynamicOpsNBT.INSTANCE, t0), (s) -> {
