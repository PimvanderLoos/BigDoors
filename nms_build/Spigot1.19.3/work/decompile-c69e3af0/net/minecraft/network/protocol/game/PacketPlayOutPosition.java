...
public class PacketPlayOutPosition implements Packet<PacketListenerPlayOut> {
    ...
    public static enum EnumPlayerTeleportFlags {
        ...
        public static final Set<PacketPlayOutPosition.EnumPlayerTeleportFlags> ALL = Set.of(values());
        public static final Set<PacketPlayOutPosition.EnumPlayerTeleportFlags> ROTATION = Set.of(PacketPlayOutPosition.EnumPlayerTeleportFlags.X_ROT, PacketPlayOutPosition.EnumPlayerTeleportFlags.Y_ROT);
