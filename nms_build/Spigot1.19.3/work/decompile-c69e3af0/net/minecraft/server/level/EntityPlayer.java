...
public class EntityPlayer extends EntityHuman {
    ...
    public void teleportTo(double d0, double d1, double d2) {
        this.connection.teleport(d0, d1, d2, this.getYRot(), this.getXRot(), PacketPlayOutPosition.EnumPlayerTeleportFlags.ROTATION);
    }

    @Override
    public void teleportRelative(double d0, double d1, double d2) {
        this.connection.teleport(this.getX() + d0, this.getY() + d1, this.getZ() + d2, this.getYRot(), this.getXRot(), PacketPlayOutPosition.EnumPlayerTeleportFlags.ALL);
    }
    ...
    public void sendServerStatus(ServerPing serverping) {
        this.connection.send(new ClientboundServerDataPacket(serverping.getDescription(), serverping.getFavicon(), serverping.enforcesSecureChat()));
    }
