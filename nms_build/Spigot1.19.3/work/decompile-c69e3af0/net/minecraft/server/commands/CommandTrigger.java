...
public class CommandTrigger {
    ...
    private static int addValue(CommandListenerWrapper commandlistenerwrapper, ScoreboardScore scoreboardscore, int i) {
        ...
        commandlistenerwrapper.sendSuccess(IChatBaseComponent.translatable("commands.trigger.add.success", scoreboardscore.getObjective().getFormattedDisplayName(), i), true);
    ...
    private static int setValue(CommandListenerWrapper commandlistenerwrapper, ScoreboardScore scoreboardscore, int i) {
        ...
        commandlistenerwrapper.sendSuccess(IChatBaseComponent.translatable("commands.trigger.set.success", scoreboardscore.getObjective().getFormattedDisplayName(), i), true);
        return i;
    }
