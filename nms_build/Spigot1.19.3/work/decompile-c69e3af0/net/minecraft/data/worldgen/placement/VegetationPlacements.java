...
public class VegetationPlacements {
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> bootstapcontext) {
        ...
        Holder<WorldGenFeatureConfigured<?, ?>> holder24 = holdergetter.getOrThrow(VegetationFeatures.TREES_PLAINS);
        Holder<WorldGenFeatureConfigured<?, ?>> holder25 = holdergetter.getOrThrow(VegetationFeatures.DARK_FOREST_VEGETATION);
        Holder<WorldGenFeatureConfigured<?, ?>> holder26 = holdergetter.getOrThrow(VegetationFeatures.FOREST_FLOWERS);
        Holder<WorldGenFeatureConfigured<?, ?>> holder27 = holdergetter.getOrThrow(VegetationFeatures.TREES_FLOWER_FOREST);
        Holder<WorldGenFeatureConfigured<?, ?>> holder28 = holdergetter.getOrThrow(VegetationFeatures.MEADOW_TREES);
        Holder<WorldGenFeatureConfigured<?, ?>> holder29 = holdergetter.getOrThrow(VegetationFeatures.TREES_TAIGA);
        Holder<WorldGenFeatureConfigured<?, ?>> holder30 = holdergetter.getOrThrow(VegetationFeatures.TREES_GROVE);
        Holder<WorldGenFeatureConfigured<?, ?>> holder31 = holdergetter.getOrThrow(TreeFeatures.OAK);
        Holder<WorldGenFeatureConfigured<?, ?>> holder32 = holdergetter.getOrThrow(TreeFeatures.SPRUCE);
        Holder<WorldGenFeatureConfigured<?, ?>> holder33 = holdergetter.getOrThrow(TreeFeatures.SWAMP_OAK);
        Holder<WorldGenFeatureConfigured<?, ?>> holder34 = holdergetter.getOrThrow(VegetationFeatures.TREES_SAVANNA);
        Holder<WorldGenFeatureConfigured<?, ?>> holder35 = holdergetter.getOrThrow(VegetationFeatures.BIRCH_TALL);
        Holder<WorldGenFeatureConfigured<?, ?>> holder36 = holdergetter.getOrThrow(TreeFeatures.BIRCH_BEES_0002);
        Holder<WorldGenFeatureConfigured<?, ?>> holder37 = holdergetter.getOrThrow(VegetationFeatures.TREES_WINDSWEPT_HILLS);
        Holder<WorldGenFeatureConfigured<?, ?>> holder38 = holdergetter.getOrThrow(VegetationFeatures.TREES_WATER);
        Holder<WorldGenFeatureConfigured<?, ?>> holder39 = holdergetter.getOrThrow(VegetationFeatures.TREES_BIRCH_AND_OAK);
        Holder<WorldGenFeatureConfigured<?, ?>> holder40 = holdergetter.getOrThrow(VegetationFeatures.TREES_SPARSE_JUNGLE);
        Holder<WorldGenFeatureConfigured<?, ?>> holder41 = holdergetter.getOrThrow(VegetationFeatures.TREES_OLD_GROWTH_SPRUCE_TAIGA);
        Holder<WorldGenFeatureConfigured<?, ?>> holder42 = holdergetter.getOrThrow(VegetationFeatures.TREES_OLD_GROWTH_PINE_TAIGA);
        Holder<WorldGenFeatureConfigured<?, ?>> holder43 = holdergetter.getOrThrow(VegetationFeatures.TREES_JUNGLE);
        Holder<WorldGenFeatureConfigured<?, ?>> holder44 = holdergetter.getOrThrow(VegetationFeatures.BAMBOO_VEGETATION);
        Holder<WorldGenFeatureConfigured<?, ?>> holder45 = holdergetter.getOrThrow(VegetationFeatures.MUSHROOM_ISLAND_VEGETATION);
        Holder<WorldGenFeatureConfigured<?, ?>> holder46 = holdergetter.getOrThrow(VegetationFeatures.MANGROVE_VEGETATION);
        ...
        PlacementUtils.register(bootstapcontext, VegetationPlacements.TREES_PLAINS, holder24, PlacementUtils.countExtra(0, 0.05F, 1), InSquarePlacement.spread(), surfacewaterdepthfilter, PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BlockPredicateFilter.forPredicate(BlockPredicate.wouldSurvive(Blocks.OAK_SAPLING.defaultBlockState(), BlockPosition.ZERO)), BiomeFilter.biome());
        PlacementUtils.register(bootstapcontext, VegetationPlacements.DARK_FOREST_VEGETATION, holder25, CountPlacement.of(16), InSquarePlacement.spread(), surfacewaterdepthfilter, PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BiomeFilter.biome());
        PlacementUtils.register(bootstapcontext, VegetationPlacements.FLOWER_FOREST_FLOWERS, holder26, RarityFilter.onAverageOnceEvery(7), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, CountPlacement.of(ClampedInt.of(UniformInt.of(-1, 3), 0, 3)), BiomeFilter.biome());
        PlacementUtils.register(bootstapcontext, VegetationPlacements.FOREST_FLOWERS, holder26, RarityFilter.onAverageOnceEvery(7), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, CountPlacement.of(ClampedInt.of(UniformInt.of(-3, 1), 0, 1)), BiomeFilter.biome());
        PlacementUtils.register(bootstapcontext, VegetationPlacements.TREES_FLOWER_FOREST, holder27, treePlacement(PlacementUtils.countExtra(6, 0.1F, 1)));
        PlacementUtils.register(bootstapcontext, VegetationPlacements.TREES_MEADOW, holder28, treePlacement(RarityFilter.onAverageOnceEvery(100)));
        PlacementUtils.register(bootstapcontext, VegetationPlacements.TREES_TAIGA, holder29, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
        PlacementUtils.register(bootstapcontext, VegetationPlacements.TREES_GROVE, holder30, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
        PlacementUtils.register(bootstapcontext, VegetationPlacements.TREES_BADLANDS, holder31, treePlacement(PlacementUtils.countExtra(5, 0.1F, 1), Blocks.OAK_SAPLING));
        PlacementUtils.register(bootstapcontext, VegetationPlacements.TREES_SNOWY, holder32, treePlacement(PlacementUtils.countExtra(0, 0.1F, 1), Blocks.SPRUCE_SAPLING));
        PlacementUtils.register(bootstapcontext, VegetationPlacements.TREES_SWAMP, holder33, PlacementUtils.countExtra(2, 0.1F, 1), InSquarePlacement.spread(), SurfaceWaterDepthFilter.forMaxDepth(2), PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BiomeFilter.biome(), BlockPredicateFilter.forPredicate(BlockPredicate.wouldSurvive(Blocks.OAK_SAPLING.defaultBlockState(), BlockPosition.ZERO)));
        PlacementUtils.register(bootstapcontext, VegetationPlacements.TREES_WINDSWEPT_SAVANNA, holder34, treePlacement(PlacementUtils.countExtra(2, 0.1F, 1)));
        PlacementUtils.register(bootstapcontext, VegetationPlacements.TREES_SAVANNA, holder34, treePlacement(PlacementUtils.countExtra(1, 0.1F, 1)));
        PlacementUtils.register(bootstapcontext, VegetationPlacements.BIRCH_TALL, holder35, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
        PlacementUtils.register(bootstapcontext, VegetationPlacements.TREES_BIRCH, holder36, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1), Blocks.BIRCH_SAPLING));
        PlacementUtils.register(bootstapcontext, VegetationPlacements.TREES_WINDSWEPT_FOREST, holder37, treePlacement(PlacementUtils.countExtra(3, 0.1F, 1)));
        PlacementUtils.register(bootstapcontext, VegetationPlacements.TREES_WINDSWEPT_HILLS, holder37, treePlacement(PlacementUtils.countExtra(0, 0.1F, 1)));
        PlacementUtils.register(bootstapcontext, VegetationPlacements.TREES_WATER, holder38, treePlacement(PlacementUtils.countExtra(0, 0.1F, 1)));
        PlacementUtils.register(bootstapcontext, VegetationPlacements.TREES_BIRCH_AND_OAK, holder39, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
        PlacementUtils.register(bootstapcontext, VegetationPlacements.TREES_SPARSE_JUNGLE, holder40, treePlacement(PlacementUtils.countExtra(2, 0.1F, 1)));
        PlacementUtils.register(bootstapcontext, VegetationPlacements.TREES_OLD_GROWTH_SPRUCE_TAIGA, holder41, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
        PlacementUtils.register(bootstapcontext, VegetationPlacements.TREES_OLD_GROWTH_PINE_TAIGA, holder42, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
        PlacementUtils.register(bootstapcontext, VegetationPlacements.TREES_JUNGLE, holder43, treePlacement(PlacementUtils.countExtra(50, 0.1F, 1)));
        PlacementUtils.register(bootstapcontext, VegetationPlacements.BAMBOO_VEGETATION, holder44, treePlacement(PlacementUtils.countExtra(30, 0.1F, 1)));
        PlacementUtils.register(bootstapcontext, VegetationPlacements.MUSHROOM_ISLAND_VEGETATION, holder45, InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        PlacementUtils.register(bootstapcontext, VegetationPlacements.TREES_MANGROVE, holder46, CountPlacement.of(25), InSquarePlacement.spread(), SurfaceWaterDepthFilter.forMaxDepth(5), PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BiomeFilter.biome(), BlockPredicateFilter.forPredicate(BlockPredicate.wouldSurvive(Blocks.MANGROVE_PROPAGULE.defaultBlockState(), BlockPosition.ZERO)));
    }
}
