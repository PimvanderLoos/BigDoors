...
public class OverworldBiomes {
    ...
    public static BiomeBase sparseJungle(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1) {
        ...
        return baseJungle(holdergetter, holdergetter1, 0.8F, false, true, false, biomesettingsmobs_a);
    }
    ...
    public static BiomeBase jungle(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1) {
        ...
        return baseJungle(holdergetter, holdergetter1, 0.9F, false, false, true, biomesettingsmobs_a);
    }
    ...
    public static BiomeBase bambooJungle(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1) {
        ...
        return baseJungle(holdergetter, holdergetter1, 0.9F, true, false, true, biomesettingsmobs_a);
    }

    private static BiomeBase baseJungle(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1, float f, boolean flag, boolean flag1, boolean flag2, BiomeSettingsMobs.a biomesettingsmobs_a) {
        BiomeSettingsGeneration.a biomesettingsgeneration_a = new BiomeSettingsGeneration.a(holdergetter, holdergetter1);
    ...
    public static BiomeBase meadow(HolderGetter<PlacedFeature> holdergetter, HolderGetter<WorldGenCarverWrapper<?>> holdergetter1) {
        BiomeSettingsGeneration.a biomesettingsgeneration_a = new BiomeSettingsGeneration.a(holdergetter, holdergetter1);
        BiomeSettingsMobs.a biomesettingsmobs_a = new BiomeSettingsMobs.a();
