...
public class TreePlacements {
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> bootstapcontext) {
        ...
        Holder<WorldGenFeatureConfigured<?, ?>> holder9 = holdergetter.getOrThrow(TreeFeatures.JUNGLE_TREE);
        Holder<WorldGenFeatureConfigured<?, ?>> holder10 = holdergetter.getOrThrow(TreeFeatures.FANCY_OAK);
        Holder<WorldGenFeatureConfigured<?, ?>> holder11 = holdergetter.getOrThrow(TreeFeatures.MEGA_JUNGLE_TREE);
        Holder<WorldGenFeatureConfigured<?, ?>> holder12 = holdergetter.getOrThrow(TreeFeatures.MEGA_SPRUCE);
        Holder<WorldGenFeatureConfigured<?, ?>> holder13 = holdergetter.getOrThrow(TreeFeatures.MEGA_PINE);
        Holder<WorldGenFeatureConfigured<?, ?>> holder14 = holdergetter.getOrThrow(TreeFeatures.TALL_MANGROVE);
        Holder<WorldGenFeatureConfigured<?, ?>> holder15 = holdergetter.getOrThrow(TreeFeatures.JUNGLE_BUSH);
        Holder<WorldGenFeatureConfigured<?, ?>> holder16 = holdergetter.getOrThrow(TreeFeatures.SUPER_BIRCH_BEES_0002);
        Holder<WorldGenFeatureConfigured<?, ?>> holder17 = holdergetter.getOrThrow(TreeFeatures.SUPER_BIRCH_BEES);
        Holder<WorldGenFeatureConfigured<?, ?>> holder18 = holdergetter.getOrThrow(TreeFeatures.OAK_BEES_0002);
        Holder<WorldGenFeatureConfigured<?, ?>> holder19 = holdergetter.getOrThrow(TreeFeatures.OAK_BEES_002);
        Holder<WorldGenFeatureConfigured<?, ?>> holder20 = holdergetter.getOrThrow(TreeFeatures.BIRCH_BEES_0002);
        Holder<WorldGenFeatureConfigured<?, ?>> holder21 = holdergetter.getOrThrow(TreeFeatures.BIRCH_BEES_002);
        Holder<WorldGenFeatureConfigured<?, ?>> holder22 = holdergetter.getOrThrow(TreeFeatures.FANCY_OAK_BEES_0002);
        Holder<WorldGenFeatureConfigured<?, ?>> holder23 = holdergetter.getOrThrow(TreeFeatures.FANCY_OAK_BEES_002);
        Holder<WorldGenFeatureConfigured<?, ?>> holder24 = holdergetter.getOrThrow(TreeFeatures.FANCY_OAK_BEES);
        ...
        PlacementUtils.register(bootstapcontext, TreePlacements.PINE_ON_SNOW, holder8, list);
        PlacementUtils.register(bootstapcontext, TreePlacements.SPRUCE_ON_SNOW, holder6, list);
        PlacementUtils.register(bootstapcontext, TreePlacements.PINE_CHECKED, holder8, PlacementUtils.filteredByBlockSurvival(Blocks.SPRUCE_SAPLING));
        PlacementUtils.register(bootstapcontext, TreePlacements.JUNGLE_TREE_CHECKED, holder9, PlacementUtils.filteredByBlockSurvival(Blocks.JUNGLE_SAPLING));
        PlacementUtils.register(bootstapcontext, TreePlacements.FANCY_OAK_CHECKED, holder10, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
        PlacementUtils.register(bootstapcontext, TreePlacements.MEGA_JUNGLE_TREE_CHECKED, holder11, PlacementUtils.filteredByBlockSurvival(Blocks.JUNGLE_SAPLING));
        PlacementUtils.register(bootstapcontext, TreePlacements.MEGA_SPRUCE_CHECKED, holder12, PlacementUtils.filteredByBlockSurvival(Blocks.SPRUCE_SAPLING));
        PlacementUtils.register(bootstapcontext, TreePlacements.MEGA_PINE_CHECKED, holder13, PlacementUtils.filteredByBlockSurvival(Blocks.SPRUCE_SAPLING));
        PlacementUtils.register(bootstapcontext, TreePlacements.TALL_MANGROVE_CHECKED, holder14, PlacementUtils.filteredByBlockSurvival(Blocks.MANGROVE_PROPAGULE));
        PlacementUtils.register(bootstapcontext, TreePlacements.JUNGLE_BUSH, holder15, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
        PlacementUtils.register(bootstapcontext, TreePlacements.SUPER_BIRCH_BEES_0002, holder16, PlacementUtils.filteredByBlockSurvival(Blocks.BIRCH_SAPLING));
        PlacementUtils.register(bootstapcontext, TreePlacements.SUPER_BIRCH_BEES, holder17, PlacementUtils.filteredByBlockSurvival(Blocks.BIRCH_SAPLING));
        PlacementUtils.register(bootstapcontext, TreePlacements.OAK_BEES_0002, holder18, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
        PlacementUtils.register(bootstapcontext, TreePlacements.OAK_BEES_002, holder19, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
        PlacementUtils.register(bootstapcontext, TreePlacements.BIRCH_BEES_0002_PLACED, holder20, PlacementUtils.filteredByBlockSurvival(Blocks.BIRCH_SAPLING));
        PlacementUtils.register(bootstapcontext, TreePlacements.BIRCH_BEES_002, holder21, PlacementUtils.filteredByBlockSurvival(Blocks.BIRCH_SAPLING));
        PlacementUtils.register(bootstapcontext, TreePlacements.FANCY_OAK_BEES_0002, holder22, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
        PlacementUtils.register(bootstapcontext, TreePlacements.FANCY_OAK_BEES_002, holder23, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
        PlacementUtils.register(bootstapcontext, TreePlacements.FANCY_OAK_BEES, holder24, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
    }
}
