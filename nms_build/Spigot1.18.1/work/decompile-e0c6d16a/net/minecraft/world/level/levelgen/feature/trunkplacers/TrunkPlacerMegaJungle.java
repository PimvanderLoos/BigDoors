...
public class TrunkPlacerMegaJungle extends TrunkPlacerGiant {
    ...
    public List<WorldGenFoilagePlacer.a> placeTrunk(VirtualLevelReadable virtuallevelreadable, BiConsumer<BlockPosition, IBlockData> biconsumer, Random random, int i, BlockPosition blockposition, WorldGenFeatureTreeConfiguration worldgenfeaturetreeconfiguration) {
        ...
        list.addAll(super.placeTrunk(virtuallevelreadable, biconsumer, random, i, blockposition, worldgenfeaturetreeconfiguration));
        ...
        for (int j = i - 2 - random.nextInt(4); j > i / 2; j -= 2 + random.nextInt(4)) {
            ...
            for (int i1 = 0; i1 < 5; ++i1) {
                ...
                placeLog(virtuallevelreadable, biconsumer, random, blockposition1, worldgenfeaturetreeconfiguration);
            }
