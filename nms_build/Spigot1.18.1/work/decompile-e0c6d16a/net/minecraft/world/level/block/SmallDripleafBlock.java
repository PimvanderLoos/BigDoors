...
public class SmallDripleafBlock extends BlockTallPlant implements IBlockFragilePlantElement, IBlockWaterlogged {
    ...
    protected boolean mayPlaceOn(IBlockData iblockdata, IBlockAccess iblockaccess, BlockPosition blockposition) {
        return iblockdata.is((Tag) TagsBlock.SMALL_DRIPLEAF_PLACEABLE) || iblockaccess.getFluidState(blockposition.above()).isSourceOfType(FluidTypes.WATER) && super.mayPlaceOn(iblockdata, iblockaccess, blockposition);
    }
