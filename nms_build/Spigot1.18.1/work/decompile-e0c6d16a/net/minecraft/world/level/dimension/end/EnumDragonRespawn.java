            ...
            if (flag1 || flag2) {
                ...
                if (j < list1.size()) {
                    ...
                    if (flag1) {
                        ...
                        worldserver.explode((Entity) null, (double) ((float) worldgenender_spike.getCenterX() + 0.5F), (double) worldgenender_spike.getHeight(), (double) ((float) worldgenender_spike.getCenterZ() + 0.5F), 5.0F, Explosion.Effect.DESTROY);
                        ...
                        WorldGenerator.END_SPIKE.configured(worldgenfeatureendspikeconfiguration).place(worldserver, worldserver.getChunkSource().getGenerator(), new Random(), new BlockPosition(worldgenender_spike.getCenterX(), 45, worldgenender_spike.getCenterZ()));
                    }
                } else if (flag1) {
