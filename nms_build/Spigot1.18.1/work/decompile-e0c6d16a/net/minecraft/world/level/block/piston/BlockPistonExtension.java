...
public class BlockPistonExtension extends BlockDirectional {
    ...
    public void neighborChanged(IBlockData iblockdata, World world, BlockPosition blockposition, Block block, BlockPosition blockposition1, boolean flag) {
        if (iblockdata.canSurvive(world, blockposition)) {
            BlockPosition blockposition2 = blockposition.relative(((EnumDirection) iblockdata.getValue(BlockPistonExtension.FACING)).getOpposite());

            world.getBlockState(blockposition2).neighborChanged(world, blockposition2, block, blockposition1, false);
        }
