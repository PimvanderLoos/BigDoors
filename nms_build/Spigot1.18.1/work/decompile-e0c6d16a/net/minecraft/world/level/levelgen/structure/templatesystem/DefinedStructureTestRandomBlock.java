...
public class DefinedStructureTestRandomBlock extends DefinedStructureRuleTest {
    ...
    public static final Codec<DefinedStructureTestRandomBlock> CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(IRegistry.BLOCK.byNameCodec().fieldOf("block").forGetter((definedstructuretestrandomblock) -> {
    ...
    public boolean test(IBlockData iblockdata, Random random) {
        return iblockdata.is(this.block) && random.nextFloat() < this.probability;
    }
