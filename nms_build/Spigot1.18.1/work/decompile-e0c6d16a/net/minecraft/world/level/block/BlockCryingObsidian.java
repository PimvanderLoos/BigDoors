        ...
        if (random.nextInt(5) == 0) {
            ...
            if (enumdirection != EnumDirection.UP) {
                ...
                if (!iblockdata.canOcclude() || !iblockdata1.isFaceSturdy(world, blockposition1, enumdirection.getOpposite())) {
                    double d0 = enumdirection.getStepX() == 0 ? random.nextDouble() : 0.5D + (double) enumdirection.getStepX() * 0.6D;
                    double d1 = enumdirection.getStepY() == 0 ? random.nextDouble() : 0.5D + (double) enumdirection.getStepY() * 0.6D;
                    double d2 = enumdirection.getStepZ() == 0 ? random.nextDouble() : 0.5D + (double) enumdirection.getStepZ() * 0.6D;
