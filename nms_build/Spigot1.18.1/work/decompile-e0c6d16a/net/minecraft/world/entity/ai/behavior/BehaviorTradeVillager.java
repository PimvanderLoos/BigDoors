...
public class BehaviorTradeVillager extends Behavior<EntityVillager> {
    ...
    private static Set<Item> figureOutWhatIAmWillingToTrade(EntityVillager entityvillager, EntityVillager entityvillager1) {
        ImmutableSet<Item> immutableset = entityvillager1.getVillagerData().getProfession().getRequestedItems();
        ImmutableSet<Item> immutableset1 = entityvillager.getVillagerData().getProfession().getRequestedItems();
