...
public class BlockIronBars extends BlockTall {
    ...
    protected BlockIronBars(Block.Info block_info) {
        ...
        this.v((IBlockData) ((IBlockData) ((IBlockData) ((IBlockData) ((IBlockData) ((IBlockData) this.blockStateList.getBlockData()).set(BlockIronBars.NORTH, Boolean.valueOf(false))).set(BlockIronBars.EAST, Boolean.valueOf(false))).set(BlockIronBars.SOUTH, Boolean.valueOf(false))).set(BlockIronBars.WEST, Boolean.valueOf(false))).set(BlockIronBars.q, Boolean.valueOf(false)));
    }
    ...
    protected void a(BlockStateList.a<Block, IBlockData> blockstatelist_a) {
        blockstatelist_a.a(new IBlockState[] { BlockIronBars.NORTH, BlockIronBars.EAST, BlockIronBars.WEST, BlockIronBars.SOUTH, BlockIronBars.q});
    }
