...
public class DebugReportAdvancementTheEnd implements Consumer<Consumer<Advancement>> {
    ...
    public void a(Consumer<Advancement> consumer) {
        ...
        Advancement advancement7 = Advancement.SerializedAdvancement.a().a(advancement4).a(Items.ELYTRA, new ChatMessage("advancements.end.elytra.title", new Object[0]), new ChatMessage("advancements.end.elytra.description", new Object[0]), (MinecraftKey) null, AdvancementFrameType.GOAL, true, true, false).a("elytra", (CriterionInstance) CriterionTriggerInventoryChanged.b.a(new IMaterial[] { Items.ELYTRA})).a(consumer, "end/elytra");
        Advancement advancement8 = Advancement.SerializedAdvancement.a().a(advancement1).a(Blocks.DRAGON_EGG, new ChatMessage("advancements.end.dragon_egg.title", new Object[0]), new ChatMessage("advancements.end.dragon_egg.description", new Object[0]), (MinecraftKey) null, AdvancementFrameType.GOAL, true, true, false).a("dragon_egg", (CriterionInstance) CriterionTriggerInventoryChanged.b.a(new IMaterial[] { Blocks.DRAGON_EGG})).a(consumer, "end/dragon_egg");
    }
