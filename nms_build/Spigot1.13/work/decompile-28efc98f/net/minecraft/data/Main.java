...
public class Main {
    ...
    public static void main(String[] astring) throws IOException {
        ...
        ArgumentAcceptingOptionSpec argumentacceptingoptionspec = optionparser.accepts("output", "Output folder").withRequiredArg().defaultsTo("generated", new String[0]);
        ArgumentAcceptingOptionSpec argumentacceptingoptionspec1 = optionparser.accepts("input", "Input folder").withRequiredArg();
