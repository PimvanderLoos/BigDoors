...
public class BehaviorExpirableMemory<E extends EntityInsentient, T> extends Behavior<E> {
    ...
    protected void start(WorldServer worldserver, E e0, long i) {
        ...
        behaviorcontroller.setMemoryWithExpiry(this.targetMemory, behaviorcontroller.getMemory(this.sourceMemory).get(), (long) this.durationOfCopy.sample(worldserver.random));
    }
}
