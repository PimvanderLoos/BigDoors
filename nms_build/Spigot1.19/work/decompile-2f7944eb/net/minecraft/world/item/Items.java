...
public class Items {
    ...
    public static final Item MUSIC_DISC_5 = registerItem("music_disc_5", new ItemRecord(15, SoundEffects.MUSIC_DISC_5, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.RARE)));
