...
public class WorldGenFoilagePlacerAcacia extends WorldGenFoilagePlacer {
    ...
    protected void createFoliage(VirtualLevelReadable virtuallevelreadable, BiConsumer<BlockPosition, IBlockData> biconsumer, RandomSource randomsource, WorldGenFeatureTreeConfiguration worldgenfeaturetreeconfiguration, int i, WorldGenFoilagePlacer.a worldgenfoilageplacer_a, int j, int k, int l) {
        ...
        this.placeLeavesRow(virtuallevelreadable, biconsumer, randomsource, worldgenfeaturetreeconfiguration, blockposition, k + worldgenfoilageplacer_a.radiusOffset(), -1 - j, flag);
        this.placeLeavesRow(virtuallevelreadable, biconsumer, randomsource, worldgenfeaturetreeconfiguration, blockposition, k - 1, -j, flag);
        this.placeLeavesRow(virtuallevelreadable, biconsumer, randomsource, worldgenfeaturetreeconfiguration, blockposition, k + worldgenfoilageplacer_a.radiusOffset() - 1, 0, flag);
    }
