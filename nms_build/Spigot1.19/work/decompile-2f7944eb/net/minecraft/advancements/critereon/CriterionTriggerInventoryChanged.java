    ...
    public static class a extends CriterionInstanceAbstract {
        ...
        public static CriterionTriggerInventoryChanged.a hasItems(IMaterial... aimaterial) {
            ...
            for (int i = 0; i < aimaterial.length; ++i) {
                acriterionconditionitem[i] = new CriterionConditionItem((TagKey) null, ImmutableSet.of(aimaterial[i].asItem()), CriterionConditionValue.IntegerRange.ANY, CriterionConditionValue.IntegerRange.ANY, CriterionConditionEnchantments.NONE, CriterionConditionEnchantments.NONE, (PotionRegistry) null, CriterionConditionNBT.ANY);
            }
