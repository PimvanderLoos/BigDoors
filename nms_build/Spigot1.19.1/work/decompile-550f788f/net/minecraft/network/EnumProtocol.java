...
public enum EnumProtocol {
    ...
    @Nullable
    public Integer getPacketId(EnumProtocolDirection enumprotocoldirection, Packet<?> packet) {
    ...
    static {
        ...
        for (int j = 0; j < i; ++j) {
            ...
            enumprotocol.flows.forEach((enumprotocoldirection, enumprotocol_a) -> {
                enumprotocol_a.getAllPackets().forEach((oclass) -> {
    ...
    private static class a<T extends PacketListener> {
        ...
        @Nullable
        public Integer getId(Class<?> oclass) {
