...
public class CaveFeatures {
    ...
    public static final Holder<WorldGenFeatureConfigured<SculkPatchConfiguration, ?>> SCULK_PATCH_DEEP_DARK = FeatureUtils.register("sculk_patch_deep_dark", WorldGenerator.SCULK_PATCH, new SculkPatchConfiguration(10, 32, 64, 0, 1, ConstantInt.of(0), 0.5F));
    public static final Holder<WorldGenFeatureConfigured<SculkPatchConfiguration, ?>> SCULK_PATCH_ANCIENT_CITY = FeatureUtils.register("sculk_patch_ancient_city", WorldGenerator.SCULK_PATCH, new SculkPatchConfiguration(10, 32, 64, 0, 1, UniformInt.of(1, 3), 0.5F));
    private static final MultifaceBlock SCULK_VEIN_BLOCK = (MultifaceBlock) Blocks.SCULK_VEIN;
    public static final Holder<WorldGenFeatureConfigured<MultifaceGrowthConfiguration, ?>> SCULK_VEIN = FeatureUtils.register("sculk_vein", WorldGenerator.MULTIFACE_GROWTH, new MultifaceGrowthConfiguration(CaveFeatures.SCULK_VEIN_BLOCK, 20, true, true, true, 1.0F, HolderSet.direct(Block::builtInRegistryHolder, (Object[])(Blocks.STONE, Blocks.ANDESITE, Blocks.DIORITE, Blocks.GRANITE, Blocks.DRIPSTONE_BLOCK, Blocks.CALCITE, Blocks.TUFF, Blocks.DEEPSLATE))));
