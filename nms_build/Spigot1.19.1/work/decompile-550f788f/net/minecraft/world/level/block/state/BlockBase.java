        ...
        private static final class Cache {
            ...
            Cache(IBlockData iblockdata) {
                ...
                if (!this.collisionShape.isEmpty() && iblockdata.getOffsetType() != BlockBase.EnumRandomOffset.NONE) {
                    throw new IllegalStateException(String.format(Locale.ROOT, "%s has a collision shape and an offset type, but is not marked as dynamicShape in its properties.", IRegistry.BLOCK.getKey(block)));
                } else {
