...
public class Items {
    ...
    public static final Item SMALL_DRIPLEAF = registerBlock((ItemBlock) (new ItemBisected(Blocks.SMALL_DRIPLEAF, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS))));
    ...
    public static final Item TORCH = registerBlock((ItemBlock) (new ItemBlockWallable(Blocks.TORCH, Blocks.WALL_TORCH, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS))));
    ...
    public static final Item SOUL_TORCH = registerBlock((ItemBlock) (new ItemBlockWallable(Blocks.SOUL_TORCH, Blocks.SOUL_WALL_TORCH, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS))));
    ...
    public static final Item LILY_PAD = registerBlock((ItemBlock) (new PlaceOnWaterBlockItem(Blocks.LILY_PAD, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS))));
    ...
    public static final Item SUNFLOWER = registerBlock((ItemBlock) (new ItemBisected(Blocks.SUNFLOWER, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS))));
    public static final Item LILAC = registerBlock((ItemBlock) (new ItemBisected(Blocks.LILAC, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS))));
    public static final Item ROSE_BUSH = registerBlock((ItemBlock) (new ItemBisected(Blocks.ROSE_BUSH, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS))));
    public static final Item PEONY = registerBlock((ItemBlock) (new ItemBisected(Blocks.PEONY, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS))));
    public static final Item TALL_GRASS = registerBlock((ItemBlock) (new ItemBisected(Blocks.TALL_GRASS, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS))));
    public static final Item LARGE_FERN = registerBlock((ItemBlock) (new ItemBisected(Blocks.LARGE_FERN, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS))));
    ...
    public static final Item TUBE_CORAL_FAN = registerBlock((ItemBlock) (new ItemBlockWallable(Blocks.TUBE_CORAL_FAN, Blocks.TUBE_CORAL_WALL_FAN, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS))));
    public static final Item BRAIN_CORAL_FAN = registerBlock((ItemBlock) (new ItemBlockWallable(Blocks.BRAIN_CORAL_FAN, Blocks.BRAIN_CORAL_WALL_FAN, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS))));
    public static final Item BUBBLE_CORAL_FAN = registerBlock((ItemBlock) (new ItemBlockWallable(Blocks.BUBBLE_CORAL_FAN, Blocks.BUBBLE_CORAL_WALL_FAN, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS))));
    public static final Item FIRE_CORAL_FAN = registerBlock((ItemBlock) (new ItemBlockWallable(Blocks.FIRE_CORAL_FAN, Blocks.FIRE_CORAL_WALL_FAN, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS))));
    public static final Item HORN_CORAL_FAN = registerBlock((ItemBlock) (new ItemBlockWallable(Blocks.HORN_CORAL_FAN, Blocks.HORN_CORAL_WALL_FAN, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS))));
    public static final Item DEAD_TUBE_CORAL_FAN = registerBlock((ItemBlock) (new ItemBlockWallable(Blocks.DEAD_TUBE_CORAL_FAN, Blocks.DEAD_TUBE_CORAL_WALL_FAN, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS))));
    public static final Item DEAD_BRAIN_CORAL_FAN = registerBlock((ItemBlock) (new ItemBlockWallable(Blocks.DEAD_BRAIN_CORAL_FAN, Blocks.DEAD_BRAIN_CORAL_WALL_FAN, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS))));
    public static final Item DEAD_BUBBLE_CORAL_FAN = registerBlock((ItemBlock) (new ItemBlockWallable(Blocks.DEAD_BUBBLE_CORAL_FAN, Blocks.DEAD_BUBBLE_CORAL_WALL_FAN, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS))));
    public static final Item DEAD_FIRE_CORAL_FAN = registerBlock((ItemBlock) (new ItemBlockWallable(Blocks.DEAD_FIRE_CORAL_FAN, Blocks.DEAD_FIRE_CORAL_WALL_FAN, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS))));
    public static final Item DEAD_HORN_CORAL_FAN = registerBlock((ItemBlock) (new ItemBlockWallable(Blocks.DEAD_HORN_CORAL_FAN, Blocks.DEAD_HORN_CORAL_WALL_FAN, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS))));
    ...
    public static final Item SCAFFOLDING = registerBlock((ItemBlock) (new ItemScaffolding(Blocks.SCAFFOLDING, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS))));
    ...
    public static final Item REDSTONE_TORCH = registerBlock((ItemBlock) (new ItemBlockWallable(Blocks.REDSTONE_TORCH, Blocks.REDSTONE_WALL_TORCH, (new Item.Info()).tab(CreativeModeTab.TAB_REDSTONE))));
    ...
    public static final Item IRON_DOOR = registerBlock((ItemBlock) (new ItemBisected(Blocks.IRON_DOOR, (new Item.Info()).tab(CreativeModeTab.TAB_REDSTONE))));
    public static final Item OAK_DOOR = registerBlock((ItemBlock) (new ItemBisected(Blocks.OAK_DOOR, (new Item.Info()).tab(CreativeModeTab.TAB_REDSTONE))));
    public static final Item SPRUCE_DOOR = registerBlock((ItemBlock) (new ItemBisected(Blocks.SPRUCE_DOOR, (new Item.Info()).tab(CreativeModeTab.TAB_REDSTONE))));
    public static final Item BIRCH_DOOR = registerBlock((ItemBlock) (new ItemBisected(Blocks.BIRCH_DOOR, (new Item.Info()).tab(CreativeModeTab.TAB_REDSTONE))));
    public static final Item JUNGLE_DOOR = registerBlock((ItemBlock) (new ItemBisected(Blocks.JUNGLE_DOOR, (new Item.Info()).tab(CreativeModeTab.TAB_REDSTONE))));
    public static final Item ACACIA_DOOR = registerBlock((ItemBlock) (new ItemBisected(Blocks.ACACIA_DOOR, (new Item.Info()).tab(CreativeModeTab.TAB_REDSTONE))));
    public static final Item DARK_OAK_DOOR = registerBlock((ItemBlock) (new ItemBisected(Blocks.DARK_OAK_DOOR, (new Item.Info()).tab(CreativeModeTab.TAB_REDSTONE))));
    public static final Item MANGROVE_DOOR = registerBlock((ItemBlock) (new ItemBisected(Blocks.MANGROVE_DOOR, (new Item.Info()).tab(CreativeModeTab.TAB_REDSTONE))));
    public static final Item CRIMSON_DOOR = registerBlock((ItemBlock) (new ItemBisected(Blocks.CRIMSON_DOOR, (new Item.Info()).tab(CreativeModeTab.TAB_REDSTONE))));
    public static final Item WARPED_DOOR = registerBlock((ItemBlock) (new ItemBisected(Blocks.WARPED_DOOR, (new Item.Info()).tab(CreativeModeTab.TAB_REDSTONE))));
    ...
    public static final Item OAK_BOAT = registerItem("oak_boat", new ItemBoat(false, EntityBoat.EnumBoatType.OAK, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
    public static final Item OAK_CHEST_BOAT = registerItem("oak_chest_boat", new ItemBoat(true, EntityBoat.EnumBoatType.OAK, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
    public static final Item SPRUCE_BOAT = registerItem("spruce_boat", new ItemBoat(false, EntityBoat.EnumBoatType.SPRUCE, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
    public static final Item SPRUCE_CHEST_BOAT = registerItem("spruce_chest_boat", new ItemBoat(true, EntityBoat.EnumBoatType.SPRUCE, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
    public static final Item BIRCH_BOAT = registerItem("birch_boat", new ItemBoat(false, EntityBoat.EnumBoatType.BIRCH, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
    public static final Item BIRCH_CHEST_BOAT = registerItem("birch_chest_boat", new ItemBoat(true, EntityBoat.EnumBoatType.BIRCH, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
    public static final Item JUNGLE_BOAT = registerItem("jungle_boat", new ItemBoat(false, EntityBoat.EnumBoatType.JUNGLE, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
    public static final Item JUNGLE_CHEST_BOAT = registerItem("jungle_chest_boat", new ItemBoat(true, EntityBoat.EnumBoatType.JUNGLE, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
    public static final Item ACACIA_BOAT = registerItem("acacia_boat", new ItemBoat(false, EntityBoat.EnumBoatType.ACACIA, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
    public static final Item ACACIA_CHEST_BOAT = registerItem("acacia_chest_boat", new ItemBoat(true, EntityBoat.EnumBoatType.ACACIA, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
    public static final Item DARK_OAK_BOAT = registerItem("dark_oak_boat", new ItemBoat(false, EntityBoat.EnumBoatType.DARK_OAK, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
    public static final Item DARK_OAK_CHEST_BOAT = registerItem("dark_oak_chest_boat", new ItemBoat(true, EntityBoat.EnumBoatType.DARK_OAK, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
    public static final Item MANGROVE_BOAT = registerItem("mangrove_boat", new ItemBoat(false, EntityBoat.EnumBoatType.MANGROVE, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
    public static final Item MANGROVE_CHEST_BOAT = registerItem("mangrove_chest_boat", new ItemBoat(true, EntityBoat.EnumBoatType.MANGROVE, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
    ...
    public static final Item MANGROVE_SIGN = registerItem("mangrove_sign", new ItemSign((new Item.Info()).stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS), Blocks.MANGROVE_SIGN, Blocks.MANGROVE_WALL_SIGN));
    ...
    public static final Item WATER_BUCKET = registerItem("water_bucket", new ItemBucket(FluidTypes.WATER, (new Item.Info()).craftRemainder(Items.BUCKET).stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
    public static final Item LAVA_BUCKET = registerItem("lava_bucket", new ItemBucket(FluidTypes.LAVA, (new Item.Info()).craftRemainder(Items.BUCKET).stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
    ...
    public static final Item MILK_BUCKET = registerItem("milk_bucket", new ItemMilkBucket((new Item.Info()).craftRemainder(Items.BUCKET).stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
    ...
    public static final Item TADPOLE_BUCKET = registerItem("tadpole_bucket", new MobBucketItem(EntityTypes.TADPOLE, FluidTypes.WATER, SoundEffects.BUCKET_EMPTY_TADPOLE, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
    ...
    public static final Item RECOVERY_COMPASS = registerItem("recovery_compass", new Item((new Item.Info()).tab(CreativeModeTab.TAB_TOOLS)));
    public static final Item BUNDLE = registerItem("bundle", new BundleItem((new Item.Info()).stacksTo(1).tab((CreativeModeTab) ifPart2(CreativeModeTab.TAB_TOOLS).orElse((Object) null))));
    ...
    public static final Item WHITE_BED = registerBlock((ItemBlock) (new ItemBed(Blocks.WHITE_BED, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS))));
    public static final Item ORANGE_BED = registerBlock((ItemBlock) (new ItemBed(Blocks.ORANGE_BED, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS))));
    public static final Item MAGENTA_BED = registerBlock((ItemBlock) (new ItemBed(Blocks.MAGENTA_BED, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS))));
    public static final Item LIGHT_BLUE_BED = registerBlock((ItemBlock) (new ItemBed(Blocks.LIGHT_BLUE_BED, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS))));
    public static final Item YELLOW_BED = registerBlock((ItemBlock) (new ItemBed(Blocks.YELLOW_BED, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS))));
    public static final Item LIME_BED = registerBlock((ItemBlock) (new ItemBed(Blocks.LIME_BED, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS))));
    public static final Item PINK_BED = registerBlock((ItemBlock) (new ItemBed(Blocks.PINK_BED, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS))));
    public static final Item GRAY_BED = registerBlock((ItemBlock) (new ItemBed(Blocks.GRAY_BED, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS))));
    public static final Item LIGHT_GRAY_BED = registerBlock((ItemBlock) (new ItemBed(Blocks.LIGHT_GRAY_BED, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS))));
    public static final Item CYAN_BED = registerBlock((ItemBlock) (new ItemBed(Blocks.CYAN_BED, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS))));
    public static final Item PURPLE_BED = registerBlock((ItemBlock) (new ItemBed(Blocks.PURPLE_BED, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS))));
    public static final Item BLUE_BED = registerBlock((ItemBlock) (new ItemBed(Blocks.BLUE_BED, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS))));
    public static final Item BROWN_BED = registerBlock((ItemBlock) (new ItemBed(Blocks.BROWN_BED, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS))));
    public static final Item GREEN_BED = registerBlock((ItemBlock) (new ItemBed(Blocks.GREEN_BED, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS))));
    public static final Item RED_BED = registerBlock((ItemBlock) (new ItemBed(Blocks.RED_BED, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS))));
    public static final Item BLACK_BED = registerBlock((ItemBlock) (new ItemBed(Blocks.BLACK_BED, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS))));
    ...
    public static final Item ALLAY_SPAWN_EGG = registerItem("allay_spawn_egg", new ItemMonsterEgg(EntityTypes.ALLAY, 56063, 44543, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    ...
    public static final Item FROG_SPAWN_EGG = registerItem("frog_spawn_egg", new ItemMonsterEgg(EntityTypes.FROG, 13661252, 16762748, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    ...
    public static final Item TADPOLE_SPAWN_EGG = registerItem("tadpole_spawn_egg", new ItemMonsterEgg(EntityTypes.TADPOLE, 7164733, 1444352, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    ...
    public static final Item WARDEN_SPAWN_EGG = registerItem("warden_spawn_egg", new ItemMonsterEgg(EntityTypes.WARDEN, 1001033, 3790560, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    ...
    public static final Item SKELETON_SKULL = registerBlock((ItemBlock) (new ItemBlockWallable(Blocks.SKELETON_SKULL, Blocks.SKELETON_WALL_SKULL, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS).rarity(EnumItemRarity.UNCOMMON))));
    public static final Item WITHER_SKELETON_SKULL = registerBlock((ItemBlock) (new ItemBlockWallable(Blocks.WITHER_SKELETON_SKULL, Blocks.WITHER_SKELETON_WALL_SKULL, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS).rarity(EnumItemRarity.UNCOMMON))));
    public static final Item PLAYER_HEAD = registerBlock((ItemBlock) (new ItemSkullPlayer(Blocks.PLAYER_HEAD, Blocks.PLAYER_WALL_HEAD, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS).rarity(EnumItemRarity.UNCOMMON))));
    public static final Item ZOMBIE_HEAD = registerBlock((ItemBlock) (new ItemBlockWallable(Blocks.ZOMBIE_HEAD, Blocks.ZOMBIE_WALL_HEAD, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS).rarity(EnumItemRarity.UNCOMMON))));
    public static final Item CREEPER_HEAD = registerBlock((ItemBlock) (new ItemBlockWallable(Blocks.CREEPER_HEAD, Blocks.CREEPER_WALL_HEAD, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS).rarity(EnumItemRarity.UNCOMMON))));
    public static final Item DRAGON_HEAD = registerBlock((ItemBlock) (new ItemBlockWallable(Blocks.DRAGON_HEAD, Blocks.DRAGON_WALL_HEAD, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS).rarity(EnumItemRarity.UNCOMMON))));
    ...
    public static final Item DRAGON_BREATH = registerItem("dragon_breath", new Item((new Item.Info()).craftRemainder(Items.GLASS_BOTTLE).tab(CreativeModeTab.TAB_BREWING).rarity(EnumItemRarity.UNCOMMON)));
    ...
    public static final Item MUSIC_DISC_13 = registerItem("music_disc_13", new ItemRecord(1, SoundEffects.MUSIC_DISC_13, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.RARE), 178));
    public static final Item MUSIC_DISC_CAT = registerItem("music_disc_cat", new ItemRecord(2, SoundEffects.MUSIC_DISC_CAT, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.RARE), 185));
    public static final Item MUSIC_DISC_BLOCKS = registerItem("music_disc_blocks", new ItemRecord(3, SoundEffects.MUSIC_DISC_BLOCKS, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.RARE), 345));
    public static final Item MUSIC_DISC_CHIRP = registerItem("music_disc_chirp", new ItemRecord(4, SoundEffects.MUSIC_DISC_CHIRP, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.RARE), 185));
    public static final Item MUSIC_DISC_FAR = registerItem("music_disc_far", new ItemRecord(5, SoundEffects.MUSIC_DISC_FAR, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.RARE), 174));
    public static final Item MUSIC_DISC_MALL = registerItem("music_disc_mall", new ItemRecord(6, SoundEffects.MUSIC_DISC_MALL, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.RARE), 197));
    public static final Item MUSIC_DISC_MELLOHI = registerItem("music_disc_mellohi", new ItemRecord(7, SoundEffects.MUSIC_DISC_MELLOHI, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.RARE), 96));
    public static final Item MUSIC_DISC_STAL = registerItem("music_disc_stal", new ItemRecord(8, SoundEffects.MUSIC_DISC_STAL, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.RARE), 150));
    public static final Item MUSIC_DISC_STRAD = registerItem("music_disc_strad", new ItemRecord(9, SoundEffects.MUSIC_DISC_STRAD, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.RARE), 188));
    public static final Item MUSIC_DISC_WARD = registerItem("music_disc_ward", new ItemRecord(10, SoundEffects.MUSIC_DISC_WARD, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.RARE), 251));
    public static final Item MUSIC_DISC_11 = registerItem("music_disc_11", new ItemRecord(11, SoundEffects.MUSIC_DISC_11, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.RARE), 71));
    public static final Item MUSIC_DISC_WAIT = registerItem("music_disc_wait", new ItemRecord(12, SoundEffects.MUSIC_DISC_WAIT, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.RARE), 238));
    public static final Item MUSIC_DISC_OTHERSIDE = registerItem("music_disc_otherside", new ItemRecord(14, SoundEffects.MUSIC_DISC_OTHERSIDE, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.RARE), 195));
    public static final Item MUSIC_DISC_5 = registerItem("music_disc_5", new ItemRecord(15, SoundEffects.MUSIC_DISC_5, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.RARE), 178));
    public static final Item MUSIC_DISC_PIGSTEP = registerItem("music_disc_pigstep", new ItemRecord(13, SoundEffects.MUSIC_DISC_PIGSTEP, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.RARE), 149));
    public static final Item DISC_FRAGMENT_5 = registerItem("disc_fragment_5", new DiscFragmentItem((new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    ...
    public static final Item FLOWER_BANNER_PATTERN = registerItem("flower_banner_pattern", new ItemBannerPattern(BannerPatternTags.PATTERN_ITEM_FLOWER, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
    public static final Item CREEPER_BANNER_PATTERN = registerItem("creeper_banner_pattern", new ItemBannerPattern(BannerPatternTags.PATTERN_ITEM_CREEPER, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.UNCOMMON)));
    public static final Item SKULL_BANNER_PATTERN = registerItem("skull_banner_pattern", new ItemBannerPattern(BannerPatternTags.PATTERN_ITEM_SKULL, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.UNCOMMON)));
    public static final Item MOJANG_BANNER_PATTERN = registerItem("mojang_banner_pattern", new ItemBannerPattern(BannerPatternTags.PATTERN_ITEM_MOJANG, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.EPIC)));
    public static final Item GLOBE_BANNER_PATTERN = registerItem("globe_banner_pattern", new ItemBannerPattern(BannerPatternTags.PATTERN_ITEM_GLOBE, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
    public static final Item PIGLIN_BANNER_PATTERN = registerItem("piglin_banner_pattern", new ItemBannerPattern(BannerPatternTags.PATTERN_ITEM_PIGLIN, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
    public static final Item GOAT_HORN = registerItem("goat_horn", new InstrumentItem((new Item.Info()).tab(CreativeModeTab.TAB_MISC).stacksTo(1), InstrumentTags.GOAT_HORNS));
    ...
    public static final Item HONEY_BOTTLE = registerItem("honey_bottle", new ItemHoneyBottle((new Item.Info()).craftRemainder(Items.GLASS_BOTTLE).food(Foods.HONEY_BOTTLE).tab(CreativeModeTab.TAB_FOOD).stacksTo(16)));
    ...
    public static final Item FROGSPAWN = registerBlock((ItemBlock) (new PlaceOnWaterBlockItem(Blocks.FROGSPAWN, (new Item.Info()).tab(CreativeModeTab.TAB_MISC))));
    public static final Item ECHO_SHARD = registerItem("echo_shard", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));

    public Items() {}

    private static <T> Optional<T> ifPart2(T t0) {
    ...
    private static Item registerBlock(Block block, CreativeModeTab creativemodetab) {
        return registerBlock(new ItemBlock(block, (new Item.Info()).tab(creativemodetab)));
    }

    private static Item registerBlock(Block block, Optional<CreativeModeTab> optional) {
        return (Item) optional.map((creativemodetab) -> {
            return registerBlock(block, creativemodetab);
        }).orElseGet(() -> {
            return registerBlock(block);
        });
    }

    private static Item registerBlock(Block block, CreativeModeTab creativemodetab, Block... ablock) {
        ItemBlock itemblock = new ItemBlock(block, (new Item.Info()).tab(creativemodetab));
    ...
    private static Item registerBlock(ItemBlock itemblock) {
    ...
    private static Item registerItem(String s, Item item) {
        return registerItem(new MinecraftKey(s), item);
    }

    private static Item registerItem(MinecraftKey minecraftkey, Item item) {
        if (item instanceof ItemBlock) {
            ((ItemBlock) item).registerBlocks(Item.BY_BLOCK, item);
        }

        return (Item) IRegistry.register(IRegistry.ITEM, minecraftkey, item);
    }
}
