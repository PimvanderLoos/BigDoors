...
public class EntityRabbit extends EntityAnimal {
    ...
    private int getRandomRabbitType(GeneratorAccess generatoraccess) {
        ...
        return ((BiomeBase) holder.value()).getPrecipitation() == BiomeBase.Precipitation.SNOW ? (i < 80 ? 1 : 3) : (holder.is(BiomeTags.ONLY_ALLOWS_SNOW_AND_GOLD_RABBITS) ? 4 : (i < 50 ? 0 : (i < 90 ? 5 : 2)));
    }
