...
public class CommandSpectate {
    ...
    private static final DynamicCommandExceptionType ERROR_NOT_SPECTATOR = new DynamicCommandExceptionType((object) -> {
        return IChatBaseComponent.translatable("commands.spectate.not_spectator", object);
    });
    ...
    private static int spectate(CommandListenerWrapper commandlistenerwrapper, @Nullable Entity entity, EntityPlayer entityplayer) throws CommandSyntaxException {
        if (entityplayer == entity) {
            ...
            if (entity != null) {
                commandlistenerwrapper.sendSuccess(IChatBaseComponent.translatable("commands.spectate.success.started", entity.getDisplayName()), false);
            } else {
                commandlistenerwrapper.sendSuccess(IChatBaseComponent.translatable("commands.spectate.success.stopped"), false);
            }
