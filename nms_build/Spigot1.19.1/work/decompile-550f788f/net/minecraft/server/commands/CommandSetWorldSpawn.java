...
public class CommandSetWorldSpawn {
    ...
    private static int setSpawn(CommandListenerWrapper commandlistenerwrapper, BlockPosition blockposition, float f) {
        ...
        commandlistenerwrapper.sendSuccess(IChatBaseComponent.translatable("commands.setworldspawn.success", blockposition.getX(), blockposition.getY(), blockposition.getZ(), f), true);
        return 1;
    }
}
