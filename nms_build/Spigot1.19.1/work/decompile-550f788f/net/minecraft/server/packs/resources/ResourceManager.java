...
public class ResourceManager implements IReloadableResourceManager {
            ...
            while (iterator1.hasNext()) {
                ...
                if (flag || flag1) {
                    ...
                    if (flag && flag1) {
                        ...
                        resourcemanagerfallback.pushFilterOnly(iresourcepack.getName(), predicate);
                    }
                }
            }
        }
    ...
    private ResourceFilterSection getPackFilterSection(IResourcePack iresourcepack) {
        try {
            ...
            ResourceManager.LOGGER.error("Failed to get filter section from pack {}", iresourcepack.getName());
            return null;
        }
    }
