...
class FallingBlockFactory_V1_21_R2 implements FallingBlockFactory
{
    private final CustomEntityFallingBlockFactory customEntityFallingBlockFactory;


    FallingBlockFactory_V1_21_R2(CustomEntityFallingBlockFactory customEntityFallingBlockFactory)
    {
    ...
    {
        final IBlockData blockData = ((NMSBlock_V1_21_R2) block).getMyBlockData();
        final CustomEntityFallingBlock_V1_21_R2 fBlockNMS =
            customEntityFallingBlockFactory.newEntityFallingBlock(
                loc.getWorld(), loc.getX(), loc.getY(), loc.getZ(), blockData);

        return new CustomCraftFallingBlock_V1_21_R2((CraftServer) Bukkit.getServer(), fBlockNMS);
    }
    ...
    public NMSBlock nmsBlockFactory(World world, int x, int y, int z)
    {
        final Info blockInfo =
            Info.a((BlockBase) ((CraftWorld) world).getHandle().a_(new BlockPosition(x, y, z)).b()).a(ResourceKey.a(Registries.f, MinecraftKey.a(String.valueOf(hashCode()))));
        return new NMSBlock_V1_21_R2(world, x, y, z, blockInfo);
    }
    ...
    {
        CustomEntityFallingBlock_V1_21_R2 newEntityFallingBlock(
