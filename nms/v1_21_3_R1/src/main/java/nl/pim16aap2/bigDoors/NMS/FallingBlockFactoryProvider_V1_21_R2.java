 ...
 */
public class FallingBlockFactoryProvider_V1_21_R2
{
    /**
    ...
    {
        return new FallingBlockFactory_V1_21_R2(
            new CustomEntityFallingBlockGenerator_V1_21_R2().getEntityFallingBlockSupplier()
        );
    }
}
