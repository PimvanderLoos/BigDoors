...
public class NMSBlock_V1_21_R6 extends BlockBase implements NMSBlock
{
    ...
    private static Field getFieldBlockMapCodec()
    {
        try
        {
            final Field field = IBlockDataHolder.class.getDeclaredField("e");
            field.setAccessible(true);
            if (field.getType() != MapCodec.class)
                throw new IllegalArgumentException("Field " + field.getName() + " is not a MapCodec");
            return field;
        }
    ...
    public NMSBlock_V1_21_R6(World world, int x, int y, int z, Info blockInfo)
    {
        super(blockInfo);
    ...
    {
        EnumDirection.EnumAxis axis = blockData.c(BlockRotatable.d);
        ...
        blockData = blockData.b(BlockRotatable.d, newAxis);
