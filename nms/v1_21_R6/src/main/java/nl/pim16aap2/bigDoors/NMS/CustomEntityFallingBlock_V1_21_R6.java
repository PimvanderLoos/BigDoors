...
public class CustomEntityFallingBlock_V1_21_R6 extends EntityFallingBlock implements CustomEntityFallingBlock
{
    private IBlockData block;
    private final CraftWorld world;

    public CustomEntityFallingBlock_V1_21_R6(
        final org.bukkit.World world, final double d0, final double d1, final double d2, final IBlockData iblockdata)
    {
        ...
        this.a(BlockPosition.a(this.dK(), this.dM(), this.dQ()));
        spawn();
    }
