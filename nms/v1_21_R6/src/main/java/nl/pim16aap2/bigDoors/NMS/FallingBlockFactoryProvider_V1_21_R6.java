 ...
 */
public class FallingBlockFactoryProvider_V1_21_R6
{
    /**
    ...
    {
        return new FallingBlockFactory_V1_21_R6(
            new CustomEntityFallingBlockGenerator_V1_21_R6().getEntityFallingBlockSupplier()
        );
    }
}
