 ...
 */
public class FallingBlockFactoryProvider_V1_21_R7
{
    /**
    ...
    {
        return new FallingBlockFactory_V1_21_R7(
            new CustomEntityFallingBlockGenerator_V1_21_R7().getEntityFallingBlockSupplier()
        );
    }
}
