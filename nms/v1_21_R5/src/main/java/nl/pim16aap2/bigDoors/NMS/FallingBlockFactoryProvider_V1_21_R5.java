 ...
 */
public class FallingBlockFactoryProvider_V1_21_R5
{
    /**
    ...
    {
        return new FallingBlockFactory_V1_21_R5(
            new CustomEntityFallingBlockGenerator_V1_21_R5().getEntityFallingBlockSupplier()
        );
    }
}
