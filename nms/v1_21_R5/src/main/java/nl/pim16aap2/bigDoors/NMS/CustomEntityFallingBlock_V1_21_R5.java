...
public class CustomEntityFallingBlock_V1_21_R5 extends EntityFallingBlock implements CustomEntityFallingBlock
{
    private IBlockData block;
    private final CraftWorld world;

    public CustomEntityFallingBlock_V1_21_R5(
        final org.bukkit.World world, final double d0, final double d1, final double d2, final IBlockData iblockdata)
    {
        ...
        this.a(BlockPosition.a(this.dC(), this.dE(), this.dI()));
        spawn();
    }
