...
public class CustomCraftFallingBlock_V1_21_R4 extends CraftEntity implements FallingBlock, CustomCraftFallingBlock
{
    public CustomCraftFallingBlock_V1_21_R4(final CraftServer server, final CustomEntityFallingBlock_V1_21_R4 entity)
    {
        super(server, entity);
    ...
    @Override
    public CustomEntityFallingBlock_V1_21_R4 getHandle()
    {
        return (CustomEntityFallingBlock_V1_21_R4) entity;
    }
