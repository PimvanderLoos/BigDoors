 ...
 */
public class FallingBlockFactoryProvider_V1_21_R4
{
    /**
    ...
    {
        return new FallingBlockFactory_V1_21_R4(
            new CustomEntityFallingBlockGenerator_V1_21_R4().getEntityFallingBlockSupplier()
        );
    }
}
