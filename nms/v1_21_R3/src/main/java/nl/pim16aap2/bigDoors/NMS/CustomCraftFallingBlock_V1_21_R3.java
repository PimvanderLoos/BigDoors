...
public class CustomCraftFallingBlock_V1_21_R3 extends CraftEntity implements FallingBlock, CustomCraftFallingBlock
{
    public CustomCraftFallingBlock_V1_21_R3(final CraftServer server, final CustomEntityFallingBlock_V1_21_R3 entity)
    {
        super(server, entity);
    ...
    @Override
    public CustomEntityFallingBlock_V1_21_R3 getHandle()
    {
        return (CustomEntityFallingBlock_V1_21_R3) entity;
    }
