...
public class CustomEntityFallingBlock_V1_21_R3 extends EntityFallingBlock implements CustomEntityFallingBlock
{
    private IBlockData block;
    private final CraftWorld world;

    public CustomEntityFallingBlock_V1_21_R3(
        final org.bukkit.World world, final double d0, final double d1, final double d2, final IBlockData iblockdata)
    {
        super(EntityTypes.X, ((CraftWorld) world).getHandle());
    ...
    {
        block = GameProfileSerializer.a(dV().a(Registries.f), nbttagcompound.p("BlockState"));
