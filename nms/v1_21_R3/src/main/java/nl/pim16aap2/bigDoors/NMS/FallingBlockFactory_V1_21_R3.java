...
class FallingBlockFactory_V1_21_R3 implements FallingBlockFactory
{
    ...
    FallingBlockFactory_V1_21_R3(CustomEntityFallingBlockFactory customEntityFallingBlockFactory)
    {
    ...
    {
        final IBlockData blockData = ((NMSBlock_V1_21_R3) block).getMyBlockData();
        final CustomEntityFallingBlock_V1_21_R3 fBlockNMS =
            customEntityFallingBlockFactory.newEntityFallingBlock(
                loc.getWorld(), loc.getX(), loc.getY(), loc.getZ(), blockData);

        return new CustomCraftFallingBlock_V1_21_R3((CraftServer) Bukkit.getServer(), fBlockNMS);
    }
    ...
    public NMSBlock nmsBlockFactory(World world, int x, int y, int z)
    {
        ...
        return new NMSBlock_V1_21_R3(world, x, y, z, blockInfo);
    }
    ...
    {
        CustomEntityFallingBlock_V1_21_R3 newEntityFallingBlock(
