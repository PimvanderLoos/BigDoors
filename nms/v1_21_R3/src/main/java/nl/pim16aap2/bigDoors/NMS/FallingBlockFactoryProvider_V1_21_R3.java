 ...
 */
public class FallingBlockFactoryProvider_V1_21_R3
{
    /**
    ...
    {
        return new FallingBlockFactory_V1_21_R3(
            new CustomEntityFallingBlockGenerator_V1_21_R3().getEntityFallingBlockSupplier()
        );
    }
}
