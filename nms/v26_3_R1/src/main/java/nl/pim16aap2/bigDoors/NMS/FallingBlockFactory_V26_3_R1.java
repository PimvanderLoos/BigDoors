...
class FallingBlockFactory_V26_3_R1 implements FallingBlockFactory
{
    ...
    FallingBlockFactory_V26_3_R1(CustomEntityFallingBlockFactory customEntityFallingBlockFactory)
    {
    ...
    {
        final BlockState blockData = ((NMSBlock_V26_3_R1) block).getMyBlockData();
        final CustomEntityFallingBlock_V26_3_R1 fBlockNMS =
        ...
        return new CustomCraftFallingBlock_V26_3_R1((CraftServer) Bukkit.getServer(), fBlockNMS);
    }
    ...
    public NMSBlock nmsBlockFactory(World world, int x, int y, int z)
    {
        ...
        return new NMSBlock_V26_3_R1(world, x, y, z, blockInfo);
    }
    ...
    {
        CustomEntityFallingBlock_V26_3_R1 newEntityFallingBlock(
            World world,
            double x,
            double y,
            double z,
