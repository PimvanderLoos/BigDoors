...
public class NMSBlock_V26_3_R1 extends BlockBehaviour implements NMSBlock
{
    ...
    {
        this.craftBlockData = CraftBlockDataFactory_V26_3_R1.fromState(blockData);
    }
