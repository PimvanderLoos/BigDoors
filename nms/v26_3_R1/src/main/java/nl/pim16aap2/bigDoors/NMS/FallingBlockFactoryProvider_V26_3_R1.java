 ...
 */
public class FallingBlockFactoryProvider_V26_3_R1
{
    /**
    ...
    public static FallingBlockFactory getFactory()
    {
        ...
        return new FallingBlockFactory_V26_3_R1(
            new CustomEntityFallingBlockGenerator_V26_3_R1().getEntityFallingBlockSupplier()
        );
    }
    ...
    private static boolean checkPreconditions()
    {
        try
        {
            return CraftBlockDataFactory_V26_3_R1.isInitialized();
        }
        catch (Throwable t)
        {
            t.printStackTrace();
