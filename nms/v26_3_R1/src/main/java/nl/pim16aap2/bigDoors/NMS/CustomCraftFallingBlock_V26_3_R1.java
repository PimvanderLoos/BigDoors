...
public class CustomCraftFallingBlock_V26_3_R1 extends CraftEntity implements FallingBlock, CustomCraftFallingBlock
{
    public CustomCraftFallingBlock_V26_3_R1(final CraftServer server, final CustomEntityFallingBlock_V26_3_R1 entity)
    {
        super(server, entity);
    ...
    @Override
    public CustomEntityFallingBlock_V26_3_R1 getHandle()
    {
        return (CustomEntityFallingBlock_V26_3_R1) entity;
    }
    ...
    {
        return CraftBlockDataFactory_V26_3_R1.fromState(this.getHandle().getBlockState());
    }
